...
from pypureclient.flasharray._common.models.data_sealing_key_v_2_57 import DataSealingKey
from pypureclient.flasharray._common.models.errorcontextresponse_errors_v_2_49 import ErrorcontextresponseErrors


class DataSealingKeyGetResponse(BaseModel):
    """
    DataSealingKeyGetResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataSealingKeyGetResponse:
        """Create an instance of DataSealingKeyGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> DataSealingKeyGetResponse:
        """Create an instance of DataSealingKeyGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DataSealingKeyGetResponse.parse_obj(obj)

        _obj = DataSealingKeyGetResponse.construct(_fields_set=None, **{
