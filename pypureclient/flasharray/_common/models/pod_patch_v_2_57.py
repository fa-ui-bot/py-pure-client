...
from pypureclient.flasharray._common.models.quota_limit_patch_v_2_57 import QuotaLimitPatch
...
class PodPatch(BaseModel):
    ...
    mediator: Optional[StrictStr] = Field(default=None, description="Sets the URL of the mediator for this pod, replacing the URL of the current mediator. By default, the Pure1 Cloud Mediator (`purestorage`) serves as the mediator. For a pod in a stretched realm, the realm mediator takes precedence over the mediator of the pod.")
    ...
    __properties = ["id", "name", "quota_limit", "destroyed", "failover_preferences", "ignore_usage", "mediator", "requested_promotion_state"]
