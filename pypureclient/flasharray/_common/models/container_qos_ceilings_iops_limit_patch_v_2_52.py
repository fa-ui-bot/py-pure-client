...
class ContainerQosCeilingsIopsLimitPatch(BaseModel):
    ...
    def validate(cls, value):
        ...
        Pydantic calls this hook whenever ContainerQosCeilingsIopsLimitPatch is used as a field type
        ...
        instead of the strict form:
            ...
            model.field = ContainerQosCeilingsIopsLimitPatch("raw-string-value")

        This hook coerces all of those into a ContainerQosCeilingsIopsLimitPatch so the
        `actual_instance` oneOf validator still runs against the wrapped value.
        """
        # Already a ContainerQosCeilingsIopsLimitPatch: pass through untouched.
