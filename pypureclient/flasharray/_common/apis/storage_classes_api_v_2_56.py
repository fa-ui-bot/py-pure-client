...
from pypureclient.flasharray._common.models.storage_classes_members_get_response_v_2_56 import StorageClassesMembersGetResponse
...
class StorageClassesApi:
    ...
    def storage_classes_members_get_with_http_info(
        self,
        ...
        storage_class_names: Annotated[Optional[conlist(StrictStr)], Field(description="The comma-separated list of `storage class` `names` to select.")] = None,
        ...
        **kwargs
        ...
        A list of the `storage class members` in the `fleet`.
        ...
        :type sort: List[str]
        :param storage_class_names: The comma-separated list of `storage class` `names` to select.
        ...
        :rtype: tuple(StorageClassesMembersGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api256_storage_classes_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "StorageClassesMembersGetResponse",
        }

        return self.api_client.call_api(
            f'/api/{self.version}/storage-classes/members', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
