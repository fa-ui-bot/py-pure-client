...
from pypureclient.flasharray._common.models.active_directory_get_response_v_2_57 import ActiveDirectoryGetResponse
from pypureclient.flasharray._common.models.active_directory_patch_v_2_57 import ActiveDirectoryPatch
from pypureclient.flasharray._common.models.active_directory_post_v_2_57 import ActiveDirectoryPost
from pypureclient.flasharray._common.models.active_directory_response_v_2_57 import ActiveDirectoryResponse
...
from pypureclient.flasharray._common.models.test_result_with_resource_patch_response_v_2_50 import TestResultWithResourcePatchResponse
...
class ActiveDirectoryApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api257_active_directory_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_active_directory_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_active_directory_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_active_directory_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_active_directory_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def active_directory_test_patch_with_http_info(
        self,
        names: Annotated[conlist(StrictStr), Field(..., description="Performs the operation on the unique name specified. For example, `name01`. Enter multiple names in comma-separated format.")],
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        context_names: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the context specified. If specified, the context names must be an array of size 1, and the single element must be the name of an array in the same fleet or the name of the fleet itself. If not specified, the context will default to the array that received this request. Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`.")] = None,
        active_directory: Annotated[Optional[ActiveDirectoryPatch], Field(description="An optional Active Directory configuration that, if provided, will be used to overwrite aspects of the existing Active Directory configuration when performing tests.")] = None,
        **kwargs
    ) -> ApiResponse:  # noqa: E501
        """PATCH active-directory/test

        Tests the configured Active Directory on the array. Optionally, modifications can be provided that will be used to perform the tests but will not be applied to the current configuration.
        ...
        :param context_names: Performs the operation on the context specified. If specified, the context names must be an array of size 1, and the single element must be the name of an array in the same fleet or the name of the fleet itself. If not specified, the context will default to the array that received this request. Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`.
        :type context_names: List[str]
        :param active_directory: An optional Active Directory configuration that, if provided, will be used to overwrite aspects of the existing Active Directory configuration when performing tests.
        :type active_directory: ActiveDirectoryPatch
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the ApiResponse.data will
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_active_directory_test_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/active-directory/test', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    # Method Aliases
    api257_active_directory_delete_with_http_info = active_directory_delete_with_http_info
    api257_active_directory_get_with_http_info = active_directory_get_with_http_info
    api257_active_directory_patch_with_http_info = active_directory_patch_with_http_info
