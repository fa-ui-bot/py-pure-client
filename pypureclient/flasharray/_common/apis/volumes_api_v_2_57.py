...
from pypureclient.flasharray._common.models.protection_groups_volumes_get_response_v_2_50 import ProtectionGroupsVolumesGetResponse
from pypureclient.flasharray._common.models.protection_groups_volumes_response_v_2_50 import ProtectionGroupsVolumesResponse
from pypureclient.flasharray._common.models.resource_performance_by_array_get_response_v_2_52 import ResourcePerformanceByArrayGetResponse
from pypureclient.flasharray._common.models.resource_performance_get_response_v_2_52 import ResourcePerformanceGetResponse
...
from pypureclient.flasharray._common.models.volume_space_get_response_v_2_50 import VolumeSpaceGetResponse
from pypureclient.flasharray._common.models.volumes_batch_response_v_2_55 import VolumesBatchResponse
from pypureclient.flasharray._common.models.volumes_diff_get_response_v_2_50 import VolumesDiffGetResponse
...
class VolumesApi:
    ...
    def volumes_batch_post_with_http_info(
        ...
        with_default_protection: Annotated[Optional[StrictBool], Field(description="The boolean value that, if `true`, indicates the initial `protection` of the newly created `volumes` will be the union of the `container` default `protection configuration` and `add_to_protection_group_names`. If `false`, the default `protection` of the `container` will not be applied automatically, and the initial `protection` of the newly created `volumes` will be configured solely by `add_to_protection_group_names`. If not specified, the value defaults to `true`.")] = None,
        **kwargs
        ...
        :type overwrite: bool
        :param with_default_protection: The boolean value that, if `true`, indicates the initial `protection` of the newly created `volumes` will be the union of the `container` default `protection configuration` and `add_to_protection_group_names`. If `false`, the default `protection` of the `container` will not be applied automatically, and the initial `protection` of the newly created `volumes` will be configured solely by `add_to_protection_group_names`. If not specified, the value defaults to `true`.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api257_volumes_batch_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_volumes_batch_test_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_volumes_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def volumes_diff_get_with_http_info(
        ...
        next_allocated_block_hint: Annotated[Optional[StrictBool], Field(description="If set to `true`, appends offset of the next allocated block in bytes for the volume specified in `names` or `ids` to the output `items`. If not specified, defaults to `false`.")] = None,
        ...
        **kwargs
        ...
        :type names: List[str]
        :param next_allocated_block_hint: If set to `true`, appends offset of the next allocated block in bytes for the volume specified in `names` or `ids` to the output `items`. If not specified, defaults to `false`.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_volumes_diff_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_volumes_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_volumes_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_volumes_performance_by_array_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_volumes_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_volumes_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_volumes_protection_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_volumes_protection_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_volumes_protection_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_volumes_qos_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_volumes_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_volumes_tags_batch_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_volumes_tags_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_volumes_tags_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_volumes_test_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_volumes_volume_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api257_volumes_batch_post_with_http_info = volumes_batch_post_with_http_info
    api257_volumes_batch_test_post_with_http_info = volumes_batch_test_post_with_http_info
    api257_volumes_delete_with_http_info = volumes_delete_with_http_info
    api257_volumes_diff_get_with_http_info = volumes_diff_get_with_http_info
    api257_volumes_get_with_http_info = volumes_get_with_http_info
    api257_volumes_patch_with_http_info = volumes_patch_with_http_info
    api257_volumes_performance_by_array_get_with_http_info = volumes_performance_by_array_get_with_http_info
    api257_volumes_performance_get_with_http_info = volumes_performance_get_with_http_info
    api257_volumes_post_with_http_info = volumes_post_with_http_info
    api257_volumes_protection_groups_delete_with_http_info = volumes_protection_groups_delete_with_http_info
    api257_volumes_protection_groups_get_with_http_info = volumes_protection_groups_get_with_http_info
    api257_volumes_protection_groups_post_with_http_info = volumes_protection_groups_post_with_http_info
    api257_volumes_qos_get_with_http_info = volumes_qos_get_with_http_info
    api257_volumes_space_get_with_http_info = volumes_space_get_with_http_info
    api257_volumes_tags_batch_put_with_http_info = volumes_tags_batch_put_with_http_info
    api257_volumes_tags_delete_with_http_info = volumes_tags_delete_with_http_info
    api257_volumes_tags_get_with_http_info = volumes_tags_get_with_http_info
    api257_volumes_test_post_with_http_info = volumes_test_post_with_http_info
    api257_volumes_volume_groups_get_with_http_info = volumes_volume_groups_get_with_http_info
