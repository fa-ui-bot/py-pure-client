...
from pypureclient.flasharray._common.models.offload_get_response_v_2_50 import OffloadGetResponse
from pypureclient.flasharray._common.models.offload_patch_v_2_50 import OffloadPatch
from pypureclient.flasharray._common.models.offload_post_v_2_50 import OffloadPost
from pypureclient.flasharray._common.models.offload_response_v_2_50 import OffloadResponse
...
class OffloadsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api250_offloads_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api250_offloads_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api250_offloads_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api250_offloads_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api250_offloads_delete_with_http_info = offloads_delete_with_http_info
    api250_offloads_get_with_http_info = offloads_get_with_http_info
    api250_offloads_patch_with_http_info = offloads_patch_with_http_info
    api250_offloads_post_with_http_info = offloads_post_with_http_info
    ...
    api255_offloads_delete_with_http_info = offloads_delete_with_http_info
    api255_offloads_get_with_http_info = offloads_get_with_http_info
    api255_offloads_patch_with_http_info = offloads_patch_with_http_info
    api255_offloads_post_with_http_info = offloads_post_with_http_info
    api256_offloads_delete_with_http_info = offloads_delete_with_http_info
