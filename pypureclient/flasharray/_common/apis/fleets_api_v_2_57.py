...
from pypureclient.flasharray._common.models.fleet_get_response_v_2_49 import FleetGetResponse
...
from pypureclient.flasharray._common.models.fleet_member_batch_post_v_2_57 import FleetMemberBatchPost
from pypureclient.flasharray._common.models.fleet_member_batch_response_v_2_57 import FleetMemberBatchResponse
from pypureclient.flasharray._common.models.fleet_member_get_response_v_2_49 import FleetMemberGetResponse
from pypureclient.flasharray._common.models.fleet_member_post_v_2_49 import FleetMemberPost
from pypureclient.flasharray._common.models.fleet_member_response_v_2_49 import FleetMemberResponse
from pypureclient.flasharray._common.models.fleet_patch_v_2_38 import FleetPatch
from pypureclient.flasharray._common.models.fleet_response_v_2_49 import FleetResponse
...
class FleetsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api257_fleets_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_fleets_fleet_key_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_fleets_fleet_key_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_fleets_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def fleets_members_batch_post_with_http_info(
        ...
        validate_target_certificates: Annotated[Optional[StrictBool], Field(description="If set to `true`, validates the certificate presented by each remote target in the batch operation using the provided `ca_certificate` or `ca_certificate_group`. If set to `false`, skips certificate validation and ignores any provided `ca_certificate` or `ca_certificate_group` values. If not specified, defaults to `true`.")] = None,
        **kwargs
    ) -> ApiResponse:  # noqa: E501
        ...
        :param validate_target_certificates: If set to `true`, validates the certificate presented by each remote target in the batch operation using the provided `ca_certificate` or `ca_certificate_group`. If set to `false`, skips certificate validation and ignores any provided `ca_certificate` or `ca_certificate_group` values. If not specified, defaults to `true`.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_fleets_members_batch_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_fleets_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_fleets_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_fleets_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_fleets_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api257_fleets_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api257_fleets_delete_with_http_info = fleets_delete_with_http_info
    api257_fleets_fleet_key_get_with_http_info = fleets_fleet_key_get_with_http_info
    api257_fleets_fleet_key_post_with_http_info = fleets_fleet_key_post_with_http_info
    api257_fleets_get_with_http_info = fleets_get_with_http_info
    api257_fleets_members_batch_post_with_http_info = fleets_members_batch_post_with_http_info
    api257_fleets_members_delete_with_http_info = fleets_members_delete_with_http_info
    api257_fleets_members_get_with_http_info = fleets_members_get_with_http_info
    api257_fleets_members_post_with_http_info = fleets_members_post_with_http_info
    api257_fleets_patch_with_http_info = fleets_patch_with_http_info
    api257_fleets_post_with_http_info = fleets_post_with_http_info
