...
class PodReplicaLinksApi:
    ...
    api257_pod_replica_links_delete_with_http_info = pod_replica_links_delete_with_http_info
    api257_pod_replica_links_get_with_http_info = pod_replica_links_get_with_http_info
    api257_pod_replica_links_lag_get_with_http_info = pod_replica_links_lag_get_with_http_info
    api257_pod_replica_links_mappings_policies_get_with_http_info = pod_replica_links_mappings_policies_get_with_http_info
    api257_pod_replica_links_mappings_policies_patch_with_http_info = pod_replica_links_mappings_policies_patch_with_http_info
    api257_pod_replica_links_patch_with_http_info = pod_replica_links_patch_with_http_info
    api257_pod_replica_links_performance_replication_by_array_get_with_http_info = pod_replica_links_performance_replication_by_array_get_with_http_info
    api257_pod_replica_links_performance_replication_get_with_http_info = pod_replica_links_performance_replication_get_with_http_info
    api257_pod_replica_links_post_with_http_info = pod_replica_links_post_with_http_info
