...
from pypureclient.flasharray._common.models.directory_group_quotas_get_response_v_2_49 import DirectoryGroupQuotasGetResponse
from pypureclient.flasharray._common.models.directory_user_quotas_get_response_v_2_49 import DirectoryUserQuotasGetResponse
...
class UserGroupQuotasApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api249_directory_group_quotas_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api249_directory_user_quotas_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api249_directory_group_quotas_get_with_http_info = directory_group_quotas_get_with_http_info
    api249_directory_user_quotas_get_with_http_info = directory_user_quotas_get_with_http_info
    api250_directory_group_quotas_get_with_http_info = directory_group_quotas_get_with_http_info
    ...
    api255_directory_group_quotas_get_with_http_info = directory_group_quotas_get_with_http_info
    api255_directory_user_quotas_get_with_http_info = directory_user_quotas_get_with_http_info
    api256_directory_group_quotas_get_with_http_info = directory_group_quotas_get_with_http_info
