...
from pypureclient.flasharray._common.models.drive_get_response_v_2_4 import DriveGetResponse
from pypureclient.flasharray._common.models.drive_response_v_2_4 import DriveResponse
...
class DrivesApi:
    ...
    def drives_patch_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/drives', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    # Method Aliases
    api236_drives_get_with_http_info = drives_get_with_http_info
    api236_drives_patch_with_http_info = drives_patch_with_http_info
    api237_drives_get_with_http_info = drives_get_with_http_info
    api237_drives_patch_with_http_info = drives_patch_with_http_info
    api238_drives_get_with_http_info = drives_get_with_http_info
    api238_drives_patch_with_http_info = drives_patch_with_http_info
    api239_drives_get_with_http_info = drives_get_with_http_info
    api239_drives_patch_with_http_info = drives_patch_with_http_info
    api240_drives_get_with_http_info = drives_get_with_http_info
    api240_drives_patch_with_http_info = drives_patch_with_http_info
    api241_drives_get_with_http_info = drives_get_with_http_info
    api241_drives_patch_with_http_info = drives_patch_with_http_info
    api242_drives_get_with_http_info = drives_get_with_http_info
    api242_drives_patch_with_http_info = drives_patch_with_http_info
    api243_drives_get_with_http_info = drives_get_with_http_info
    api243_drives_patch_with_http_info = drives_patch_with_http_info
    api244_drives_get_with_http_info = drives_get_with_http_info
    api244_drives_patch_with_http_info = drives_patch_with_http_info
    api245_drives_get_with_http_info = drives_get_with_http_info
    api245_drives_patch_with_http_info = drives_patch_with_http_info
    api246_drives_get_with_http_info = drives_get_with_http_info
    api246_drives_patch_with_http_info = drives_patch_with_http_info
    api247_drives_get_with_http_info = drives_get_with_http_info
    api247_drives_patch_with_http_info = drives_patch_with_http_info
    api248_drives_get_with_http_info = drives_get_with_http_info
    api248_drives_patch_with_http_info = drives_patch_with_http_info
    api249_drives_get_with_http_info = drives_get_with_http_info
    api249_drives_patch_with_http_info = drives_patch_with_http_info
    api250_drives_get_with_http_info = drives_get_with_http_info
    api250_drives_patch_with_http_info = drives_patch_with_http_info
    api251_drives_get_with_http_info = drives_get_with_http_info
    api251_drives_patch_with_http_info = drives_patch_with_http_info
    api252_drives_get_with_http_info = drives_get_with_http_info
    api252_drives_patch_with_http_info = drives_patch_with_http_info
    api253_drives_get_with_http_info = drives_get_with_http_info
