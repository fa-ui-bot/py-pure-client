...
from pypureclient.flasharray._common.models.session_get_response_v_2_4 import SessionGetResponse
...
class SessionsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api236_sessions_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    api252_sessions_get_with_http_info = sessions_get_with_http_info
    api253_sessions_get_with_http_info = sessions_get_with_http_info
    api254_sessions_get_with_http_info = sessions_get_with_http_info
