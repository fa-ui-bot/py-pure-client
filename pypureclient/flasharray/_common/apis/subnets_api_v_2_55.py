...
from pypureclient.flasharray._common.models.subnet_get_response_v_2_55 import SubnetGetResponse
...
from pypureclient.flasharray._common.models.subnet_response_v_2_55 import SubnetResponse
...
class SubnetsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api255_subnets_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api255_subnets_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api255_subnets_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api255_subnets_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api255_subnets_delete_with_http_info = subnets_delete_with_http_info
    api255_subnets_get_with_http_info = subnets_get_with_http_info
    api255_subnets_patch_with_http_info = subnets_patch_with_http_info
    api255_subnets_post_with_http_info = subnets_post_with_http_info
    api256_subnets_delete_with_http_info = subnets_delete_with_http_info
    api256_subnets_get_with_http_info = subnets_get_with_http_info
    api256_subnets_patch_with_http_info = subnets_patch_with_http_info
    api256_subnets_post_with_http_info = subnets_post_with_http_info
    api257_subnets_delete_with_http_info = subnets_delete_with_http_info
