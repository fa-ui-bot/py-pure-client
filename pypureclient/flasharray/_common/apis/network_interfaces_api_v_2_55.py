...
from pypureclient.flasharray._common.models.network_interface_get_response_v_2_55 import NetworkInterfaceGetResponse
from pypureclient.flasharray._common.models.network_interface_neighbor_get_response_v_2_22 import NetworkInterfaceNeighborGetResponse
from pypureclient.flasharray._common.models.network_interface_patch_v_2_55 import NetworkInterfacePatch
from pypureclient.flasharray._common.models.network_interface_performance_get_response_v_2_36 import NetworkInterfacePerformanceGetResponse
from pypureclient.flasharray._common.models.network_interface_post_v_2_55 import NetworkInterfacePost
from pypureclient.flasharray._common.models.network_interface_response_v_2_55 import NetworkInterfaceResponse
from pypureclient.flasharray._common.models.network_interfaces_port_details_get_response_v_2_16 import NetworkInterfacesPortDetailsGetResponse
...
class NetworkInterfacesApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api255_network_interfaces_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api255_network_interfaces_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api255_network_interfaces_neighbors_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def network_interfaces_patch_with_http_info(
        ...
        context_names: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the context specified. If specified, the context names must be an array of size 1, and the single element must be the name of an array in the same fleet or the name of the fleet itself. If not specified, the context will default to the array that received this request. Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`.")] = None,
        names: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the unique names specified. Enter multiple names in comma-separated format. For example, `name01,name02`. If there is not at least one resource that matches each of the elements of `names`, then an error is returned, except when creating new resources.")] = None,
        remediate: Annotated[Optional[StrictBool], Field(description="The boolean value that, if `true`, indicates that `network interfaces` with a `remediation_mode` of `manual` will migrate to their `preferred_arrays`, if configured.")] = None,
        **kwargs
    ) -> ApiResponse:  # noqa: E501
        ...
        :param names: Performs the operation on the unique names specified. Enter multiple names in comma-separated format. For example, `name01,name02`. If there is not at least one resource that matches each of the elements of `names`, then an error is returned, except when creating new resources.
        :type names: List[str]
        :param remediate: The boolean value that, if `true`, indicates that `network interfaces` with a `remediation_mode` of `manual` will migrate to their `preferred_arrays`, if configured.
        :type remediate: bool
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the ApiResponse.data will
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api255_network_interfaces_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('remediate') is not None:  # noqa: E501
            _query_params.append(('remediate', _params['remediate']))
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api255_network_interfaces_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api255_network_interfaces_port_details_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api255_network_interfaces_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api255_network_interfaces_delete_with_http_info = network_interfaces_delete_with_http_info
    api255_network_interfaces_get_with_http_info = network_interfaces_get_with_http_info
    api255_network_interfaces_neighbors_get_with_http_info = network_interfaces_neighbors_get_with_http_info
    api255_network_interfaces_patch_with_http_info = network_interfaces_patch_with_http_info
    api255_network_interfaces_performance_get_with_http_info = network_interfaces_performance_get_with_http_info
    api255_network_interfaces_port_details_get_with_http_info = network_interfaces_port_details_get_with_http_info
    api255_network_interfaces_post_with_http_info = network_interfaces_post_with_http_info
    api256_network_interfaces_delete_with_http_info = network_interfaces_delete_with_http_info
    api256_network_interfaces_get_with_http_info = network_interfaces_get_with_http_info
    api256_network_interfaces_neighbors_get_with_http_info = network_interfaces_neighbors_get_with_http_info
    api256_network_interfaces_patch_with_http_info = network_interfaces_patch_with_http_info
    api256_network_interfaces_performance_get_with_http_info = network_interfaces_performance_get_with_http_info
    api256_network_interfaces_port_details_get_with_http_info = network_interfaces_port_details_get_with_http_info
    api256_network_interfaces_post_with_http_info = network_interfaces_post_with_http_info
    api257_network_interfaces_delete_with_http_info = network_interfaces_delete_with_http_info
    api257_network_interfaces_get_with_http_info = network_interfaces_get_with_http_info
    api257_network_interfaces_neighbors_get_with_http_info = network_interfaces_neighbors_get_with_http_info
    api257_network_interfaces_patch_with_http_info = network_interfaces_patch_with_http_info
    api257_network_interfaces_performance_get_with_http_info = network_interfaces_performance_get_with_http_info
    api257_network_interfaces_port_details_get_with_http_info = network_interfaces_port_details_get_with_http_info
    api257_network_interfaces_post_with_http_info = network_interfaces_post_with_http_info
