...
from pypureclient.flasharray._common.models.admin_api_token_get_response_v_2_54 import AdminApiTokenGetResponse
from pypureclient.flasharray._common.models.admin_api_token_response_v_2_54 import AdminApiTokenResponse
from pypureclient.flasharray._common.models.admin_cache_get_response_v_2_54 import AdminCacheGetResponse
from pypureclient.flasharray._common.models.admin_cache_response_v_2_54 import AdminCacheResponse
from pypureclient.flasharray._common.models.admin_get_response_v_2_54 import AdminGetResponse
from pypureclient.flasharray._common.models.admin_patch_v_2_54 import AdminPatch
from pypureclient.flasharray._common.models.admin_post_v_2_54 import AdminPost
from pypureclient.flasharray._common.models.admin_response_v_2_54 import AdminResponse
from pypureclient.flasharray._common.models.admin_settings_get_response_v_2_32 import AdminSettingsGetResponse
from pypureclient.flasharray._common.models.admin_settings_response_v_2_32 import AdminSettingsResponse
from pypureclient.flasharray._common.models.admin_settings_v_2_32 import AdminSettings
...
class AdministratorsApi:
    ...
    def admins_api_tokens_delete_with_http_info(
        ...
        **kwargs
        ...
        The operation that deletes the `API tokens` of the specified `administrators`.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api254_admins_api_tokens_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api254_admins_api_tokens_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def admins_api_tokens_post_with_http_info(
        ...
        **kwargs
        ...
        The operation that creates `API tokens` for the specified `administrators`.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api254_admins_api_tokens_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def admins_cache_delete_with_http_info(
        ...
        **kwargs
        ...
        The operation that deletes all `entries` from the `administrator cache`.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api254_admins_cache_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api254_admins_cache_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def admins_cache_put_with_http_info(
        ...
        **kwargs
        ...
        The operation that updates entries in the `cache` for `administrators` who currently do not have a `cache entry`; otherwise, it refreshes the existing entry.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api254_admins_cache_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def admins_delete_with_http_info(
        ...
        **kwargs
        ...
        The operation that deletes the specified `administrator`.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api254_admins_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api254_admins_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def admins_patch_with_http_info(
        ...
        **kwargs
        ...
        The operation that modifies `properties` for the specified `administrator`.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api254_admins_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api254_admins_policies_management_access_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api254_admins_policies_management_access_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api254_admins_policies_management_access_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def admins_post_with_http_info(
        ...
        **kwargs
        ...
        The operation that creates an `administrator`.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api254_admins_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api254_admins_settings_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api254_admins_settings_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api254_admins_api_tokens_delete_with_http_info = admins_api_tokens_delete_with_http_info
    api254_admins_api_tokens_get_with_http_info = admins_api_tokens_get_with_http_info
    api254_admins_api_tokens_post_with_http_info = admins_api_tokens_post_with_http_info
    api254_admins_cache_delete_with_http_info = admins_cache_delete_with_http_info
    api254_admins_cache_get_with_http_info = admins_cache_get_with_http_info
    api254_admins_cache_put_with_http_info = admins_cache_put_with_http_info
    api254_admins_delete_with_http_info = admins_delete_with_http_info
    api254_admins_get_with_http_info = admins_get_with_http_info
    api254_admins_patch_with_http_info = admins_patch_with_http_info
    api254_admins_policies_management_access_delete_with_http_info = admins_policies_management_access_delete_with_http_info
    api254_admins_policies_management_access_get_with_http_info = admins_policies_management_access_get_with_http_info
    api254_admins_policies_management_access_post_with_http_info = admins_policies_management_access_post_with_http_info
    api254_admins_post_with_http_info = admins_post_with_http_info
    api254_admins_settings_get_with_http_info = admins_settings_get_with_http_info
    api254_admins_settings_patch_with_http_info = admins_settings_patch_with_http_info
    api255_admins_api_tokens_delete_with_http_info = admins_api_tokens_delete_with_http_info
    api255_admins_api_tokens_get_with_http_info = admins_api_tokens_get_with_http_info
    api255_admins_api_tokens_post_with_http_info = admins_api_tokens_post_with_http_info
    api255_admins_cache_delete_with_http_info = admins_cache_delete_with_http_info
    api255_admins_cache_get_with_http_info = admins_cache_get_with_http_info
    api255_admins_cache_put_with_http_info = admins_cache_put_with_http_info
    api255_admins_delete_with_http_info = admins_delete_with_http_info
    api255_admins_get_with_http_info = admins_get_with_http_info
    api255_admins_patch_with_http_info = admins_patch_with_http_info
    api255_admins_policies_management_access_delete_with_http_info = admins_policies_management_access_delete_with_http_info
    api255_admins_policies_management_access_get_with_http_info = admins_policies_management_access_get_with_http_info
    api255_admins_policies_management_access_post_with_http_info = admins_policies_management_access_post_with_http_info
    api255_admins_post_with_http_info = admins_post_with_http_info
    api255_admins_settings_get_with_http_info = admins_settings_get_with_http_info
    api255_admins_settings_patch_with_http_info = admins_settings_patch_with_http_info
    api256_admins_api_tokens_delete_with_http_info = admins_api_tokens_delete_with_http_info
    api256_admins_api_tokens_get_with_http_info = admins_api_tokens_get_with_http_info
    api256_admins_api_tokens_post_with_http_info = admins_api_tokens_post_with_http_info
    api256_admins_cache_delete_with_http_info = admins_cache_delete_with_http_info
    api256_admins_cache_get_with_http_info = admins_cache_get_with_http_info
    api256_admins_cache_put_with_http_info = admins_cache_put_with_http_info
    api256_admins_delete_with_http_info = admins_delete_with_http_info
    api256_admins_get_with_http_info = admins_get_with_http_info
    api256_admins_patch_with_http_info = admins_patch_with_http_info
    api256_admins_policies_management_access_delete_with_http_info = admins_policies_management_access_delete_with_http_info
    api256_admins_policies_management_access_get_with_http_info = admins_policies_management_access_get_with_http_info
    api256_admins_policies_management_access_post_with_http_info = admins_policies_management_access_post_with_http_info
    api256_admins_post_with_http_info = admins_post_with_http_info
    api256_admins_settings_get_with_http_info = admins_settings_get_with_http_info
    api256_admins_settings_patch_with_http_info = admins_settings_patch_with_http_info
    api257_admins_api_tokens_delete_with_http_info = admins_api_tokens_delete_with_http_info
    api257_admins_api_tokens_get_with_http_info = admins_api_tokens_get_with_http_info
    api257_admins_api_tokens_post_with_http_info = admins_api_tokens_post_with_http_info
    api257_admins_cache_delete_with_http_info = admins_cache_delete_with_http_info
    api257_admins_cache_get_with_http_info = admins_cache_get_with_http_info
    api257_admins_cache_put_with_http_info = admins_cache_put_with_http_info
    api257_admins_delete_with_http_info = admins_delete_with_http_info
    api257_admins_get_with_http_info = admins_get_with_http_info
    api257_admins_patch_with_http_info = admins_patch_with_http_info
    api257_admins_policies_management_access_delete_with_http_info = admins_policies_management_access_delete_with_http_info
    api257_admins_policies_management_access_get_with_http_info = admins_policies_management_access_get_with_http_info
    api257_admins_policies_management_access_post_with_http_info = admins_policies_management_access_post_with_http_info
    api257_admins_post_with_http_info = admins_post_with_http_info
    api257_admins_settings_get_with_http_info = admins_settings_get_with_http_info
    api257_admins_settings_patch_with_http_info = admins_settings_patch_with_http_info
