...
from pypureclient.flasharray._common.models.subscription_asset_get_response_v_2_26 import SubscriptionAssetGetResponse
...
class SubscriptionAssetsApi:
    ...
    def subscription_assets_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/subscription-assets', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    # Method Aliases
    api236_subscription_assets_get_with_http_info = subscription_assets_get_with_http_info
    api237_subscription_assets_get_with_http_info = subscription_assets_get_with_http_info
    api238_subscription_assets_get_with_http_info = subscription_assets_get_with_http_info
    api239_subscription_assets_get_with_http_info = subscription_assets_get_with_http_info
    api240_subscription_assets_get_with_http_info = subscription_assets_get_with_http_info
    api241_subscription_assets_get_with_http_info = subscription_assets_get_with_http_info
    api242_subscription_assets_get_with_http_info = subscription_assets_get_with_http_info
    api243_subscription_assets_get_with_http_info = subscription_assets_get_with_http_info
    api244_subscription_assets_get_with_http_info = subscription_assets_get_with_http_info
    api245_subscription_assets_get_with_http_info = subscription_assets_get_with_http_info
    api246_subscription_assets_get_with_http_info = subscription_assets_get_with_http_info
    api247_subscription_assets_get_with_http_info = subscription_assets_get_with_http_info
    api248_subscription_assets_get_with_http_info = subscription_assets_get_with_http_info
    api249_subscription_assets_get_with_http_info = subscription_assets_get_with_http_info
    api250_subscription_assets_get_with_http_info = subscription_assets_get_with_http_info
    api251_subscription_assets_get_with_http_info = subscription_assets_get_with_http_info
    api252_subscription_assets_get_with_http_info = subscription_assets_get_with_http_info
    api253_subscription_assets_get_with_http_info = subscription_assets_get_with_http_info
