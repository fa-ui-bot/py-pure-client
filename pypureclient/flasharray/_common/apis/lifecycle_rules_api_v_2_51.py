...
from pypureclient.flasharray._common.models.lifecycle_rule_get_response_v_2_51 import LifecycleRuleGetResponse
from pypureclient.flasharray._common.models.lifecycle_rule_patch_base_v_2_51 import LifecycleRulePatchBase
from pypureclient.flasharray._common.models.lifecycle_rule_post_base_v_2_51 import LifecycleRulePostBase
from pypureclient.flasharray._common.models.lifecycle_rule_response_v_2_51 import LifecycleRuleResponse
...
class LifecycleRulesApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api251_lifecycle_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_lifecycle_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_lifecycle_rules_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api251_lifecycle_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api251_lifecycle_rules_delete_with_http_info = lifecycle_rules_delete_with_http_info
    api251_lifecycle_rules_get_with_http_info = lifecycle_rules_get_with_http_info
    api251_lifecycle_rules_patch_with_http_info = lifecycle_rules_patch_with_http_info
    api251_lifecycle_rules_post_with_http_info = lifecycle_rules_post_with_http_info
    ...
    api253_lifecycle_rules_delete_with_http_info = lifecycle_rules_delete_with_http_info
    api253_lifecycle_rules_get_with_http_info = lifecycle_rules_get_with_http_info
    api253_lifecycle_rules_patch_with_http_info = lifecycle_rules_patch_with_http_info
    api253_lifecycle_rules_post_with_http_info = lifecycle_rules_post_with_http_info
    api254_lifecycle_rules_delete_with_http_info = lifecycle_rules_delete_with_http_info
    ...
    api257_lifecycle_rules_delete_with_http_info = lifecycle_rules_delete_with_http_info
