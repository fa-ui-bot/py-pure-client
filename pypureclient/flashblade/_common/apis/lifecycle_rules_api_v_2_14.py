...
class LifecycleRulesApi:
    ...
    # Method Aliases
    api214_lifecycle_rules_delete_with_http_info = lifecycle_rules_delete_with_http_info
    api214_lifecycle_rules_get_with_http_info = lifecycle_rules_get_with_http_info
    api214_lifecycle_rules_patch_with_http_info = lifecycle_rules_patch_with_http_info
    api214_lifecycle_rules_post_with_http_info = lifecycle_rules_post_with_http_info
    api215_lifecycle_rules_delete_with_http_info = lifecycle_rules_delete_with_http_info
    api215_lifecycle_rules_get_with_http_info = lifecycle_rules_get_with_http_info
    api215_lifecycle_rules_patch_with_http_info = lifecycle_rules_patch_with_http_info
    api215_lifecycle_rules_post_with_http_info = lifecycle_rules_post_with_http_info
    api216_lifecycle_rules_delete_with_http_info = lifecycle_rules_delete_with_http_info
    api216_lifecycle_rules_get_with_http_info = lifecycle_rules_get_with_http_info
    api216_lifecycle_rules_patch_with_http_info = lifecycle_rules_patch_with_http_info
    api216_lifecycle_rules_post_with_http_info = lifecycle_rules_post_with_http_info
