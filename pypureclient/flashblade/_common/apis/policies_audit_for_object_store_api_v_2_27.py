...
from pypureclient.flashblade._common.models.audit_object_store_policies_get_response_v_2_26 import AuditObjectStorePoliciesGetResponse
...
from pypureclient.flashblade._common.models.audit_object_store_policies_patch_v_2_26 import AuditObjectStorePoliciesPatch
from pypureclient.flashblade._common.models.audit_object_store_policies_post_v_2_26 import AuditObjectStorePoliciesPost
from pypureclient.flashblade._common.models.audit_object_store_policies_response_v_2_26 import AuditObjectStorePoliciesResponse
...
class PoliciesAuditForObjectStoreApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_audit_object_store_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_audit_object_store_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_audit_object_store_policies_members_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_audit_object_store_policies_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_audit_object_store_policies_members_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_audit_object_store_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_audit_object_store_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api227_audit_object_store_policies_delete_with_http_info = audit_object_store_policies_delete_with_http_info
    api227_audit_object_store_policies_get_with_http_info = audit_object_store_policies_get_with_http_info
    api227_audit_object_store_policies_members_delete_with_http_info = audit_object_store_policies_members_delete_with_http_info
    api227_audit_object_store_policies_members_get_with_http_info = audit_object_store_policies_members_get_with_http_info
    api227_audit_object_store_policies_members_post_with_http_info = audit_object_store_policies_members_post_with_http_info
    api227_audit_object_store_policies_patch_with_http_info = audit_object_store_policies_patch_with_http_info
    api227_audit_object_store_policies_post_with_http_info = audit_object_store_policies_post_with_http_info
    api228_audit_object_store_policies_delete_with_http_info = audit_object_store_policies_delete_with_http_info
    api228_audit_object_store_policies_get_with_http_info = audit_object_store_policies_get_with_http_info
    api228_audit_object_store_policies_members_delete_with_http_info = audit_object_store_policies_members_delete_with_http_info
    api228_audit_object_store_policies_members_get_with_http_info = audit_object_store_policies_members_get_with_http_info
    api228_audit_object_store_policies_members_post_with_http_info = audit_object_store_policies_members_post_with_http_info
    api228_audit_object_store_policies_patch_with_http_info = audit_object_store_policies_patch_with_http_info
    api228_audit_object_store_policies_post_with_http_info = audit_object_store_policies_post_with_http_info
