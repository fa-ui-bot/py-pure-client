...
from pypureclient.flashblade._common.models.policy_get_response_v_2_14 import PolicyGetResponse
...
from pypureclient.flashblade._common.models.policy_patch_v_2_14 import PolicyPatch
from pypureclient.flashblade._common.models.policy_response_v_2_14 import PolicyResponse
from pypureclient.flashblade._common.models.policy_v_2_14 import Policy
...
class PoliciesSnapshotApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api214_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_policies_file_system_replica_links_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_policies_file_system_replica_links_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_policies_file_system_replica_links_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_policies_file_system_snapshots_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_policies_file_system_snapshots_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_policies_file_systems_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_policies_file_systems_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_policies_file_systems_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_policies_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api214_policies_delete_with_http_info = policies_delete_with_http_info
    api214_policies_file_system_replica_links_delete_with_http_info = policies_file_system_replica_links_delete_with_http_info
    api214_policies_file_system_replica_links_get_with_http_info = policies_file_system_replica_links_get_with_http_info
    api214_policies_file_system_replica_links_post_with_http_info = policies_file_system_replica_links_post_with_http_info
    api214_policies_file_system_snapshots_delete_with_http_info = policies_file_system_snapshots_delete_with_http_info
    api214_policies_file_system_snapshots_get_with_http_info = policies_file_system_snapshots_get_with_http_info
    api214_policies_file_systems_delete_with_http_info = policies_file_systems_delete_with_http_info
    api214_policies_file_systems_get_with_http_info = policies_file_systems_get_with_http_info
    api214_policies_file_systems_post_with_http_info = policies_file_systems_post_with_http_info
    ...
    api214_policies_patch_with_http_info = policies_patch_with_http_info
    api214_policies_post_with_http_info = policies_post_with_http_info
    api215_policies_delete_with_http_info = policies_delete_with_http_info
    api215_policies_file_system_replica_links_delete_with_http_info = policies_file_system_replica_links_delete_with_http_info
    api215_policies_file_system_replica_links_get_with_http_info = policies_file_system_replica_links_get_with_http_info
    api215_policies_file_system_replica_links_post_with_http_info = policies_file_system_replica_links_post_with_http_info
    api215_policies_file_system_snapshots_delete_with_http_info = policies_file_system_snapshots_delete_with_http_info
    api215_policies_file_system_snapshots_get_with_http_info = policies_file_system_snapshots_get_with_http_info
    api215_policies_file_systems_delete_with_http_info = policies_file_systems_delete_with_http_info
    api215_policies_file_systems_get_with_http_info = policies_file_systems_get_with_http_info
    api215_policies_file_systems_post_with_http_info = policies_file_systems_post_with_http_info
    ...
    api215_policies_patch_with_http_info = policies_patch_with_http_info
    api215_policies_post_with_http_info = policies_post_with_http_info
    api216_policies_delete_with_http_info = policies_delete_with_http_info
    api216_policies_file_system_replica_links_delete_with_http_info = policies_file_system_replica_links_delete_with_http_info
    api216_policies_file_system_replica_links_get_with_http_info = policies_file_system_replica_links_get_with_http_info
    api216_policies_file_system_replica_links_post_with_http_info = policies_file_system_replica_links_post_with_http_info
    api216_policies_file_system_snapshots_delete_with_http_info = policies_file_system_snapshots_delete_with_http_info
    api216_policies_file_system_snapshots_get_with_http_info = policies_file_system_snapshots_get_with_http_info
    api216_policies_file_systems_delete_with_http_info = policies_file_systems_delete_with_http_info
    api216_policies_file_systems_get_with_http_info = policies_file_systems_get_with_http_info
    api216_policies_file_systems_post_with_http_info = policies_file_systems_post_with_http_info
    ...
    api216_policies_patch_with_http_info = policies_patch_with_http_info
    api216_policies_post_with_http_info = policies_post_with_http_info
