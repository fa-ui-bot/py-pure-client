...
from pypureclient.flashblade._common.models.support_diagnostics_settings_get_response_v_2_24 import SupportDiagnosticsSettingsGetResponse
from pypureclient.flashblade._common.models.support_diagnostics_settings_response_v_2_24 import SupportDiagnosticsSettingsResponse
...
class SupportDiagnosticsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api224_support_diagnostics_details_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_support_diagnostics_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_support_diagnostics_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_support_diagnostics_settings_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api224_support_diagnostics_settings_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api224_support_diagnostics_details_get_with_http_info = support_diagnostics_details_get_with_http_info
    api224_support_diagnostics_get_with_http_info = support_diagnostics_get_with_http_info
    api224_support_diagnostics_post_with_http_info = support_diagnostics_post_with_http_info
    api224_support_diagnostics_settings_get_with_http_info = support_diagnostics_settings_get_with_http_info
    api224_support_diagnostics_settings_patch_with_http_info = support_diagnostics_settings_patch_with_http_info
    api225_support_diagnostics_details_get_with_http_info = support_diagnostics_details_get_with_http_info
    api225_support_diagnostics_get_with_http_info = support_diagnostics_get_with_http_info
    api225_support_diagnostics_post_with_http_info = support_diagnostics_post_with_http_info
    api225_support_diagnostics_settings_get_with_http_info = support_diagnostics_settings_get_with_http_info
    api225_support_diagnostics_settings_patch_with_http_info = support_diagnostics_settings_patch_with_http_info
