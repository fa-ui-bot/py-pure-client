...
from pypureclient.flashblade._common.models.worm_data_policies_get_response_v_2_17 import WormDataPoliciesGetResponse
...
from pypureclient.flashblade._common.models.worm_data_policies_response_v_2_17 import WormDataPoliciesResponse
...
class PoliciesWORMDataApi:
    ...
    # Method Aliases
    api217_worm_data_policies_delete_with_http_info = worm_data_policies_delete_with_http_info
    api217_worm_data_policies_get_with_http_info = worm_data_policies_get_with_http_info
    api217_worm_data_policies_members_get_with_http_info = worm_data_policies_members_get_with_http_info
    api217_worm_data_policies_patch_with_http_info = worm_data_policies_patch_with_http_info
    api217_worm_data_policies_post_with_http_info = worm_data_policies_post_with_http_info
    api218_worm_data_policies_delete_with_http_info = worm_data_policies_delete_with_http_info
    api218_worm_data_policies_get_with_http_info = worm_data_policies_get_with_http_info
    api218_worm_data_policies_members_get_with_http_info = worm_data_policies_members_get_with_http_info
    api218_worm_data_policies_patch_with_http_info = worm_data_policies_patch_with_http_info
    api218_worm_data_policies_post_with_http_info = worm_data_policies_post_with_http_info
    api219_worm_data_policies_delete_with_http_info = worm_data_policies_delete_with_http_info
    api219_worm_data_policies_get_with_http_info = worm_data_policies_get_with_http_info
    api219_worm_data_policies_members_get_with_http_info = worm_data_policies_members_get_with_http_info
    api219_worm_data_policies_patch_with_http_info = worm_data_policies_patch_with_http_info
    api219_worm_data_policies_post_with_http_info = worm_data_policies_post_with_http_info
    api220_worm_data_policies_delete_with_http_info = worm_data_policies_delete_with_http_info
    api220_worm_data_policies_get_with_http_info = worm_data_policies_get_with_http_info
    api220_worm_data_policies_members_get_with_http_info = worm_data_policies_members_get_with_http_info
    api220_worm_data_policies_patch_with_http_info = worm_data_policies_patch_with_http_info
    api220_worm_data_policies_post_with_http_info = worm_data_policies_post_with_http_info
    api221_worm_data_policies_delete_with_http_info = worm_data_policies_delete_with_http_info
    api221_worm_data_policies_get_with_http_info = worm_data_policies_get_with_http_info
    api221_worm_data_policies_members_get_with_http_info = worm_data_policies_members_get_with_http_info
    api221_worm_data_policies_patch_with_http_info = worm_data_policies_patch_with_http_info
    api221_worm_data_policies_post_with_http_info = worm_data_policies_post_with_http_info
