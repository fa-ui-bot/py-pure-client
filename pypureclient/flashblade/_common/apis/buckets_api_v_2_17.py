...
from pypureclient.flashblade._common.models.bucket_access_policy_get_response_v_2_17 import BucketAccessPolicyGetResponse
from pypureclient.flashblade._common.models.bucket_access_policy_post_v_2_12 import BucketAccessPolicyPost
from pypureclient.flashblade._common.models.bucket_access_policy_response_v_2_17 import BucketAccessPolicyResponse
...
from pypureclient.flashblade._common.models.bucket_get_response_v_2_17 import BucketGetResponse
...
from pypureclient.flashblade._common.models.bucket_response_v_2_17 import BucketResponse
...
from pypureclient.flashblade._common.models.cross_origin_resource_sharing_policy_get_response_v_2_17 import CrossOriginResourceSharingPolicyGetResponse
...
from pypureclient.flashblade._common.models.cross_origin_resource_sharing_policy_response_v_2_17 import CrossOriginResourceSharingPolicyResponse
...
class BucketsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api217_buckets_bucket_access_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_buckets_bucket_access_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_buckets_bucket_access_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_buckets_bucket_access_policies_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_buckets_bucket_access_policies_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_buckets_bucket_access_policies_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_buckets_cross_origin_resource_sharing_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_buckets_cross_origin_resource_sharing_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_buckets_cross_origin_resource_sharing_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_buckets_cross_origin_resource_sharing_policies_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_buckets_cross_origin_resource_sharing_policies_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_buckets_cross_origin_resource_sharing_policies_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_buckets_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_buckets_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_buckets_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_buckets_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_buckets_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_buckets_s3_specific_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api217_buckets_bucket_access_policies_delete_with_http_info = buckets_bucket_access_policies_delete_with_http_info
    api217_buckets_bucket_access_policies_get_with_http_info = buckets_bucket_access_policies_get_with_http_info
    api217_buckets_bucket_access_policies_post_with_http_info = buckets_bucket_access_policies_post_with_http_info
    api217_buckets_bucket_access_policies_rules_delete_with_http_info = buckets_bucket_access_policies_rules_delete_with_http_info
    api217_buckets_bucket_access_policies_rules_get_with_http_info = buckets_bucket_access_policies_rules_get_with_http_info
    api217_buckets_bucket_access_policies_rules_post_with_http_info = buckets_bucket_access_policies_rules_post_with_http_info
    api217_buckets_cross_origin_resource_sharing_policies_delete_with_http_info = buckets_cross_origin_resource_sharing_policies_delete_with_http_info
    api217_buckets_cross_origin_resource_sharing_policies_get_with_http_info = buckets_cross_origin_resource_sharing_policies_get_with_http_info
    api217_buckets_cross_origin_resource_sharing_policies_post_with_http_info = buckets_cross_origin_resource_sharing_policies_post_with_http_info
    api217_buckets_cross_origin_resource_sharing_policies_rules_delete_with_http_info = buckets_cross_origin_resource_sharing_policies_rules_delete_with_http_info
    api217_buckets_cross_origin_resource_sharing_policies_rules_get_with_http_info = buckets_cross_origin_resource_sharing_policies_rules_get_with_http_info
    api217_buckets_cross_origin_resource_sharing_policies_rules_post_with_http_info = buckets_cross_origin_resource_sharing_policies_rules_post_with_http_info
    api217_buckets_delete_with_http_info = buckets_delete_with_http_info
    api217_buckets_get_with_http_info = buckets_get_with_http_info
    api217_buckets_patch_with_http_info = buckets_patch_with_http_info
    api217_buckets_performance_get_with_http_info = buckets_performance_get_with_http_info
    api217_buckets_post_with_http_info = buckets_post_with_http_info
    api217_buckets_s3_specific_performance_get_with_http_info = buckets_s3_specific_performance_get_with_http_info
    api218_buckets_bucket_access_policies_delete_with_http_info = buckets_bucket_access_policies_delete_with_http_info
    api218_buckets_bucket_access_policies_get_with_http_info = buckets_bucket_access_policies_get_with_http_info
    api218_buckets_bucket_access_policies_post_with_http_info = buckets_bucket_access_policies_post_with_http_info
    api218_buckets_bucket_access_policies_rules_delete_with_http_info = buckets_bucket_access_policies_rules_delete_with_http_info
    api218_buckets_bucket_access_policies_rules_get_with_http_info = buckets_bucket_access_policies_rules_get_with_http_info
    api218_buckets_bucket_access_policies_rules_post_with_http_info = buckets_bucket_access_policies_rules_post_with_http_info
    api218_buckets_cross_origin_resource_sharing_policies_delete_with_http_info = buckets_cross_origin_resource_sharing_policies_delete_with_http_info
    api218_buckets_cross_origin_resource_sharing_policies_get_with_http_info = buckets_cross_origin_resource_sharing_policies_get_with_http_info
    api218_buckets_cross_origin_resource_sharing_policies_post_with_http_info = buckets_cross_origin_resource_sharing_policies_post_with_http_info
    api218_buckets_cross_origin_resource_sharing_policies_rules_delete_with_http_info = buckets_cross_origin_resource_sharing_policies_rules_delete_with_http_info
    api218_buckets_cross_origin_resource_sharing_policies_rules_get_with_http_info = buckets_cross_origin_resource_sharing_policies_rules_get_with_http_info
    api218_buckets_cross_origin_resource_sharing_policies_rules_post_with_http_info = buckets_cross_origin_resource_sharing_policies_rules_post_with_http_info
    api218_buckets_delete_with_http_info = buckets_delete_with_http_info
    api218_buckets_get_with_http_info = buckets_get_with_http_info
    api218_buckets_patch_with_http_info = buckets_patch_with_http_info
    api218_buckets_performance_get_with_http_info = buckets_performance_get_with_http_info
    api218_buckets_post_with_http_info = buckets_post_with_http_info
    api218_buckets_s3_specific_performance_get_with_http_info = buckets_s3_specific_performance_get_with_http_info
