...
class LogsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api214_logs_async_download_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_logs_async_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_logs_async_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_logs_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api214_logs_async_download_get_with_http_info = logs_async_download_get_with_http_info
    api214_logs_async_get_with_http_info = logs_async_get_with_http_info
    api214_logs_async_patch_with_http_info = logs_async_patch_with_http_info
    api214_logs_get_with_http_info = logs_get_with_http_info
    api215_logs_async_download_get_with_http_info = logs_async_download_get_with_http_info
    api215_logs_async_get_with_http_info = logs_async_get_with_http_info
    api215_logs_async_patch_with_http_info = logs_async_patch_with_http_info
    api215_logs_get_with_http_info = logs_get_with_http_info
    api216_logs_async_download_get_with_http_info = logs_async_download_get_with_http_info
    api216_logs_async_get_with_http_info = logs_async_get_with_http_info
    api216_logs_async_patch_with_http_info = logs_async_patch_with_http_info
    api216_logs_get_with_http_info = logs_get_with_http_info
