...
from pypureclient.flashblade._common.models.worm_data_policies_get_response_v_2_15 import WormDataPoliciesGetResponse
...
from pypureclient.flashblade._common.models.worm_data_policies_response_v_2_15 import WormDataPoliciesResponse
...
class PoliciesWORMDataApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api215_worm_data_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_worm_data_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_worm_data_policies_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_worm_data_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api215_worm_data_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api215_worm_data_policies_delete_with_http_info = worm_data_policies_delete_with_http_info
    api215_worm_data_policies_get_with_http_info = worm_data_policies_get_with_http_info
    api215_worm_data_policies_members_get_with_http_info = worm_data_policies_members_get_with_http_info
    api215_worm_data_policies_patch_with_http_info = worm_data_policies_patch_with_http_info
    api215_worm_data_policies_post_with_http_info = worm_data_policies_post_with_http_info
    api216_worm_data_policies_delete_with_http_info = worm_data_policies_delete_with_http_info
    api216_worm_data_policies_get_with_http_info = worm_data_policies_get_with_http_info
    api216_worm_data_policies_members_get_with_http_info = worm_data_policies_members_get_with_http_info
    api216_worm_data_policies_patch_with_http_info = worm_data_policies_patch_with_http_info
    api216_worm_data_policies_post_with_http_info = worm_data_policies_post_with_http_info
