...
class ObjectStoreAccountsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_object_store_accounts_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_object_store_accounts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_object_store_accounts_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_object_store_accounts_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api227_object_store_accounts_delete_with_http_info = object_store_accounts_delete_with_http_info
    api227_object_store_accounts_get_with_http_info = object_store_accounts_get_with_http_info
    api227_object_store_accounts_patch_with_http_info = object_store_accounts_patch_with_http_info
    api227_object_store_accounts_post_with_http_info = object_store_accounts_post_with_http_info
    api228_object_store_accounts_delete_with_http_info = object_store_accounts_delete_with_http_info
