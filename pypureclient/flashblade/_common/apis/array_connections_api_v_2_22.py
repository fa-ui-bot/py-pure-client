...
from pypureclient.flashblade._common.models.array_connection_get_response_v_2_22 import ArrayConnectionGetResponse
...
from pypureclient.flashblade._common.models.array_connection_path_get_response_v_2_22 import ArrayConnectionPathGetResponse
from pypureclient.flashblade._common.models.array_connection_post_v_2_22 import ArrayConnectionPost
from pypureclient.flashblade._common.models.array_connection_response_v_2_22 import ArrayConnectionResponse
...
class ArrayConnectionsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api222_array_connections_connection_key_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_array_connections_connection_key_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_array_connections_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_array_connections_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_array_connections_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_array_connections_path_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_array_connections_performance_replication_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_array_connections_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    api222_array_connections_connection_key_post_with_http_info = array_connections_connection_key_post_with_http_info
    ...
    api222_array_connections_performance_replication_get_with_http_info = array_connections_performance_replication_get_with_http_info
    ...
    api223_array_connections_connection_key_post_with_http_info = array_connections_connection_key_post_with_http_info
    ...
    api223_array_connections_performance_replication_get_with_http_info = array_connections_performance_replication_get_with_http_info
    ...
    api225_array_connections_connection_key_post_with_http_info = array_connections_connection_key_post_with_http_info
    ...
    api225_array_connections_performance_replication_get_with_http_info = array_connections_performance_replication_get_with_http_info
