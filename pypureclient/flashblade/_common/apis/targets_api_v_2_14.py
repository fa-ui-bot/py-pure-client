...
class TargetsApi:
    ...
    # Method Aliases
    api214_targets_delete_with_http_info = targets_delete_with_http_info
    api214_targets_get_with_http_info = targets_get_with_http_info
    api214_targets_patch_with_http_info = targets_patch_with_http_info
    api214_targets_performance_replication_get_with_http_info = targets_performance_replication_get_with_http_info
    api214_targets_post_with_http_info = targets_post_with_http_info
    api215_targets_delete_with_http_info = targets_delete_with_http_info
    api215_targets_get_with_http_info = targets_get_with_http_info
    api215_targets_patch_with_http_info = targets_patch_with_http_info
    api215_targets_performance_replication_get_with_http_info = targets_performance_replication_get_with_http_info
    api215_targets_post_with_http_info = targets_post_with_http_info
    api216_targets_delete_with_http_info = targets_delete_with_http_info
    api216_targets_get_with_http_info = targets_get_with_http_info
    api216_targets_patch_with_http_info = targets_patch_with_http_info
    api216_targets_performance_replication_get_with_http_info = targets_performance_replication_get_with_http_info
    api216_targets_post_with_http_info = targets_post_with_http_info
