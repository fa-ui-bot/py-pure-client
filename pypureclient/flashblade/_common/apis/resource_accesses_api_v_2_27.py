...
from pypureclient.flashblade._common.models.resource_access_post_v_2_26 import ResourceAccessPost
from pypureclient.flashblade._common.models.resource_accesses_get_response_v_2_22 import ResourceAccessesGetResponse
from pypureclient.flashblade._common.models.resource_accesses_response_v_2_22 import ResourceAccessesResponse
...
class ResourceAccessesApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_resource_accesses_batch_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_resource_accesses_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_resource_accesses_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api227_resource_accesses_batch_post_with_http_info = resource_accesses_batch_post_with_http_info
    api227_resource_accesses_delete_with_http_info = resource_accesses_delete_with_http_info
    api227_resource_accesses_get_with_http_info = resource_accesses_get_with_http_info
