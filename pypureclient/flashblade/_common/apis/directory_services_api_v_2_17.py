...
class DirectoryServicesApi:
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_directory_services_roles_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_directory_services_roles_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_directory_services_test_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api217_directory_services_get_with_http_info = directory_services_get_with_http_info
    api217_directory_services_patch_with_http_info = directory_services_patch_with_http_info
    api217_directory_services_roles_delete_with_http_info = directory_services_roles_delete_with_http_info
    api217_directory_services_roles_get_with_http_info = directory_services_roles_get_with_http_info
    api217_directory_services_roles_patch_with_http_info = directory_services_roles_patch_with_http_info
    api217_directory_services_roles_post_with_http_info = directory_services_roles_post_with_http_info
    api217_directory_services_test_get_with_http_info = directory_services_test_get_with_http_info
    api217_directory_services_test_patch_with_http_info = directory_services_test_patch_with_http_info
    api218_directory_services_get_with_http_info = directory_services_get_with_http_info
    api218_directory_services_patch_with_http_info = directory_services_patch_with_http_info
    api218_directory_services_roles_delete_with_http_info = directory_services_roles_delete_with_http_info
    api218_directory_services_roles_get_with_http_info = directory_services_roles_get_with_http_info
    api218_directory_services_roles_patch_with_http_info = directory_services_roles_patch_with_http_info
    api218_directory_services_roles_post_with_http_info = directory_services_roles_post_with_http_info
    api218_directory_services_test_get_with_http_info = directory_services_test_get_with_http_info
    api218_directory_services_test_patch_with_http_info = directory_services_test_patch_with_http_info
