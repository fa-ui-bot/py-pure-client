...
from pypureclient.flashblade._common.models.file_system_export_get_response_v_2_16 import FileSystemExportGetResponse
from pypureclient.flashblade._common.models.file_system_export_post_v_2_16 import FileSystemExportPost
from pypureclient.flashblade._common.models.file_system_export_response_v_2_16 import FileSystemExportResponse
from pypureclient.flashblade._common.models.file_system_export_v_2_16 import FileSystemExport
...
class FileSystemExportsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api216_file_system_exports_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_file_system_exports_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_file_system_exports_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_file_system_exports_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api216_file_system_exports_delete_with_http_info = file_system_exports_delete_with_http_info
    api216_file_system_exports_get_with_http_info = file_system_exports_get_with_http_info
    api216_file_system_exports_patch_with_http_info = file_system_exports_patch_with_http_info
    api216_file_system_exports_post_with_http_info = file_system_exports_post_with_http_info
