...
class RealmsApi:
    ...
    # Method Aliases
    api219_realms_delete_with_http_info = realms_delete_with_http_info
    api219_realms_get_with_http_info = realms_get_with_http_info
    api219_realms_patch_with_http_info = realms_patch_with_http_info
    api219_realms_post_with_http_info = realms_post_with_http_info
    api219_realms_space_get_with_http_info = realms_space_get_with_http_info
    api219_realms_space_storage_classes_get_with_http_info = realms_space_storage_classes_get_with_http_info
