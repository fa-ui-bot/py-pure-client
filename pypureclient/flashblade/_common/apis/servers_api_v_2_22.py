...
from pypureclient.flashblade._common.models.server_get_response_v_2_22 import ServerGetResponse
from pypureclient.flashblade._common.models.server_post_v_2_22 import ServerPost
from pypureclient.flashblade._common.models.server_response_v_2_22 import ServerResponse
...
class ServersApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api222_servers_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_servers_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_servers_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api222_servers_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api222_servers_delete_with_http_info = servers_delete_with_http_info
    api222_servers_get_with_http_info = servers_get_with_http_info
    api222_servers_patch_with_http_info = servers_patch_with_http_info
    api222_servers_post_with_http_info = servers_post_with_http_info
    api223_servers_delete_with_http_info = servers_delete_with_http_info
    api223_servers_get_with_http_info = servers_get_with_http_info
    api223_servers_patch_with_http_info = servers_patch_with_http_info
    api223_servers_post_with_http_info = servers_post_with_http_info
