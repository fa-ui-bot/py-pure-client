...
from pypureclient.flashblade._common.models.file_system_get_response_v_2_16 import FileSystemGetResponse
...
from pypureclient.flashblade._common.models.file_system_patch_v_2_16 import FileSystemPatch
...
from pypureclient.flashblade._common.models.file_system_post_v_2_16 import FileSystemPost
from pypureclient.flashblade._common.models.file_system_response_v_2_16 import FileSystemResponse
...
class FileSystemsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api216_file_systems_audit_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_file_systems_audit_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_file_systems_audit_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_file_systems_groups_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_file_systems_locks_clients_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_file_systems_locks_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_file_systems_locks_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_file_systems_locks_nlm_reclamations_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_file_systems_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_file_systems_policies_all_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_file_systems_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_file_systems_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_file_systems_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_file_systems_sessions_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_file_systems_sessions_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_file_systems_users_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api216_file_systems_worm_data_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api216_file_systems_audit_policies_delete_with_http_info = file_systems_audit_policies_delete_with_http_info
    api216_file_systems_audit_policies_get_with_http_info = file_systems_audit_policies_get_with_http_info
    api216_file_systems_audit_policies_post_with_http_info = file_systems_audit_policies_post_with_http_info
    ...
    api216_file_systems_groups_performance_get_with_http_info = file_systems_groups_performance_get_with_http_info
    api216_file_systems_locks_clients_get_with_http_info = file_systems_locks_clients_get_with_http_info
    api216_file_systems_locks_delete_with_http_info = file_systems_locks_delete_with_http_info
    api216_file_systems_locks_get_with_http_info = file_systems_locks_get_with_http_info
    api216_file_systems_locks_nlm_reclamations_post_with_http_info = file_systems_locks_nlm_reclamations_post_with_http_info
    api216_file_systems_patch_with_http_info = file_systems_patch_with_http_info
    api216_file_systems_performance_get_with_http_info = file_systems_performance_get_with_http_info
    api216_file_systems_policies_all_get_with_http_info = file_systems_policies_all_get_with_http_info
    api216_file_systems_policies_delete_with_http_info = file_systems_policies_delete_with_http_info
    api216_file_systems_policies_get_with_http_info = file_systems_policies_get_with_http_info
    api216_file_systems_policies_post_with_http_info = file_systems_policies_post_with_http_info
    api216_file_systems_post_with_http_info = file_systems_post_with_http_info
    api216_file_systems_sessions_delete_with_http_info = file_systems_sessions_delete_with_http_info
    api216_file_systems_sessions_get_with_http_info = file_systems_sessions_get_with_http_info
    api216_file_systems_users_performance_get_with_http_info = file_systems_users_performance_get_with_http_info
    api216_file_systems_worm_data_policies_get_with_http_info = file_systems_worm_data_policies_get_with_http_info
