...
class VerificationKeysApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api214_support_verification_keys_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_support_verification_keys_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api214_support_verification_keys_get_with_http_info = support_verification_keys_get_with_http_info
    api214_support_verification_keys_patch_with_http_info = support_verification_keys_patch_with_http_info
    api215_support_verification_keys_get_with_http_info = support_verification_keys_get_with_http_info
    api215_support_verification_keys_patch_with_http_info = support_verification_keys_patch_with_http_info
    api216_support_verification_keys_get_with_http_info = support_verification_keys_get_with_http_info
    api216_support_verification_keys_patch_with_http_info = support_verification_keys_patch_with_http_info
