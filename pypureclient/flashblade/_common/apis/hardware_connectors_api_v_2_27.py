...
from pypureclient.flashblade._common.models.hardware_connector_get_response_v_2_20 import HardwareConnectorGetResponse
from pypureclient.flashblade._common.models.hardware_connector_performance_get_response_v_2_22 import HardwareConnectorPerformanceGetResponse
from pypureclient.flashblade._common.models.hardware_connector_response_v_2_20 import HardwareConnectorResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_hardware_connectors_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_hardware_connectors_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_hardware_connectors_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
