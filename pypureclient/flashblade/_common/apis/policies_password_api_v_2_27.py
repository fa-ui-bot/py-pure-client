...
from pypureclient.flashblade._common.models.password_policies_get_response_v_2_25 import PasswordPoliciesGetResponse
from pypureclient.flashblade._common.models.password_policies_response_v_2_25 import PasswordPoliciesResponse
from pypureclient.flashblade._common.models.password_policy_v_2_25 import PasswordPolicy
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_password_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_password_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
