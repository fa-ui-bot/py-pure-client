...
from pypureclient.flashblade._common.models.active_directory_get_response_v_2_27 import ActiveDirectoryGetResponse
from pypureclient.flashblade._common.models.active_directory_patch_v_2_27 import ActiveDirectoryPatch
from pypureclient.flashblade._common.models.active_directory_post_v_2_27 import ActiveDirectoryPost
from pypureclient.flashblade._common.models.active_directory_response_v_2_27 import ActiveDirectoryResponse
from pypureclient.flashblade._common.models.active_directory_test_patch_v_2_27 import ActiveDirectoryTestPatch
...
class ActiveDirectoryApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_active_directory_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_active_directory_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_active_directory_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_active_directory_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_active_directory_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def active_directory_test_patch_with_http_info(
        ...
        ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        names: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the unique names specified. Enter multiple names in comma-separated format. For example, `name01,name02`. If there is not at least one resource that matches each of the elements of `names`, then an error is returned, except when creating new resources.")] = None,
        active_directory: Annotated[Optional[ActiveDirectoryTestPatch], Field(description="An optional Active Directory configuration that, if provided, will be used to overwrite aspects of the existing Active Directory configuration when performing tests.")] = None,
        **kwargs
    ) -> ApiResponse:  # noqa: E501
        """PATCH active-directory/test

        Test the configured Active Directory on the array. Optionally, provide modifications which will be used to perform the tests, but will not be applied to the current configuration.
        ...
        :type active_directory: ActiveDirectoryTestPatch
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the ApiResponse.data will
                                 be set to none and raw_data will store the
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_active_directory_test_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
