...
from pypureclient.flashblade._common.models.object_store_account_export_get_response_v_2_20 import ObjectStoreAccountExportGetResponse
from pypureclient.flashblade._common.models.object_store_account_export_patch_v_2_20 import ObjectStoreAccountExportPatch
from pypureclient.flashblade._common.models.object_store_account_export_post_v_2_20 import ObjectStoreAccountExportPost
from pypureclient.flashblade._common.models.object_store_account_export_response_v_2_20 import ObjectStoreAccountExportResponse
...
class ObjectStoreAccountExportsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api220_object_store_account_exports_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api220_object_store_account_exports_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api220_object_store_account_exports_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api220_object_store_account_exports_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api220_object_store_account_exports_delete_with_http_info = object_store_account_exports_delete_with_http_info
    api220_object_store_account_exports_get_with_http_info = object_store_account_exports_get_with_http_info
    api220_object_store_account_exports_patch_with_http_info = object_store_account_exports_patch_with_http_info
    api220_object_store_account_exports_post_with_http_info = object_store_account_exports_post_with_http_info
    api221_object_store_account_exports_delete_with_http_info = object_store_account_exports_delete_with_http_info
    api221_object_store_account_exports_get_with_http_info = object_store_account_exports_get_with_http_info
    api221_object_store_account_exports_patch_with_http_info = object_store_account_exports_patch_with_http_info
    api221_object_store_account_exports_post_with_http_info = object_store_account_exports_post_with_http_info
