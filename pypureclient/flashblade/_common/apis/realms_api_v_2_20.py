...
from pypureclient.flashblade._common.models.realm_defaults_get_response_v_2_20 import RealmDefaultsGetResponse
from pypureclient.flashblade._common.models.realm_defaults_response_v_2_20 import RealmDefaultsResponse
from pypureclient.flashblade._common.models.realm_defaults_v_2_20 import RealmDefaults
from pypureclient.flashblade._common.models.realm_get_response_v_2_19 import RealmGetResponse
from pypureclient.flashblade._common.models.realm_patch_v_2_19 import RealmPatch
from pypureclient.flashblade._common.models.realm_response_v_2_19 import RealmResponse
...
class RealmsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api220_realms_defaults_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api220_realms_defaults_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api220_realms_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api220_realms_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api220_realms_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api220_realms_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api220_realms_space_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api220_realms_space_storage_classes_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api220_realms_defaults_get_with_http_info = realms_defaults_get_with_http_info
    api220_realms_defaults_patch_with_http_info = realms_defaults_patch_with_http_info
    api220_realms_delete_with_http_info = realms_delete_with_http_info
    api220_realms_get_with_http_info = realms_get_with_http_info
    api220_realms_patch_with_http_info = realms_patch_with_http_info
    api220_realms_post_with_http_info = realms_post_with_http_info
    api220_realms_space_get_with_http_info = realms_space_get_with_http_info
    api220_realms_space_storage_classes_get_with_http_info = realms_space_storage_classes_get_with_http_info
    api221_realms_defaults_get_with_http_info = realms_defaults_get_with_http_info
    api221_realms_defaults_patch_with_http_info = realms_defaults_patch_with_http_info
    api221_realms_delete_with_http_info = realms_delete_with_http_info
    api221_realms_get_with_http_info = realms_get_with_http_info
    api221_realms_patch_with_http_info = realms_patch_with_http_info
    api221_realms_post_with_http_info = realms_post_with_http_info
    api221_realms_space_get_with_http_info = realms_space_get_with_http_info
    api221_realms_space_storage_classes_get_with_http_info = realms_space_storage_classes_get_with_http_info
