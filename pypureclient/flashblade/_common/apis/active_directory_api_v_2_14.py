...
from pypureclient.flashblade._common.models.active_directory_get_response_v_2_12 import ActiveDirectoryGetResponse
...
from pypureclient.flashblade._common.models.active_directory_response_v_2_12 import ActiveDirectoryResponse
...
class ActiveDirectoryApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api214_active_directory_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_active_directory_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_active_directory_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_active_directory_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_active_directory_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    api214_active_directory_patch_with_http_info = active_directory_patch_with_http_info
    api214_active_directory_post_with_http_info = active_directory_post_with_http_info
    api214_active_directory_test_get_with_http_info = active_directory_test_get_with_http_info
    ...
    api215_active_directory_test_get_with_http_info = active_directory_test_get_with_http_info
    ...
    api216_active_directory_test_get_with_http_info = active_directory_test_get_with_http_info
