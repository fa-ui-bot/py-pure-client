...
from pypureclient.flashblade._common.models.nfs_export_policy_get_response_v_2_25 import NfsExportPolicyGetResponse
from pypureclient.flashblade._common.models.nfs_export_policy_patch_v_2_25 import NfsExportPolicyPatch
from pypureclient.flashblade._common.models.nfs_export_policy_post_v_2_25 import NfsExportPolicyPost
from pypureclient.flashblade._common.models.nfs_export_policy_response_v_2_25 import NfsExportPolicyResponse
...
class PoliciesNFSApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_nfs_export_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_nfs_export_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_nfs_export_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_nfs_export_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_nfs_export_policies_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_nfs_export_policies_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_nfs_export_policies_rules_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_nfs_export_policies_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api227_nfs_export_policies_delete_with_http_info = nfs_export_policies_delete_with_http_info
    api227_nfs_export_policies_get_with_http_info = nfs_export_policies_get_with_http_info
    api227_nfs_export_policies_patch_with_http_info = nfs_export_policies_patch_with_http_info
    api227_nfs_export_policies_post_with_http_info = nfs_export_policies_post_with_http_info
    api227_nfs_export_policies_rules_delete_with_http_info = nfs_export_policies_rules_delete_with_http_info
    api227_nfs_export_policies_rules_get_with_http_info = nfs_export_policies_rules_get_with_http_info
    api227_nfs_export_policies_rules_patch_with_http_info = nfs_export_policies_rules_patch_with_http_info
    api227_nfs_export_policies_rules_post_with_http_info = nfs_export_policies_rules_post_with_http_info
    api228_nfs_export_policies_delete_with_http_info = nfs_export_policies_delete_with_http_info
    api228_nfs_export_policies_get_with_http_info = nfs_export_policies_get_with_http_info
    api228_nfs_export_policies_patch_with_http_info = nfs_export_policies_patch_with_http_info
    api228_nfs_export_policies_post_with_http_info = nfs_export_policies_post_with_http_info
    api228_nfs_export_policies_rules_delete_with_http_info = nfs_export_policies_rules_delete_with_http_info
    api228_nfs_export_policies_rules_get_with_http_info = nfs_export_policies_rules_get_with_http_info
    api228_nfs_export_policies_rules_patch_with_http_info = nfs_export_policies_rules_patch_with_http_info
    api228_nfs_export_policies_rules_post_with_http_info = nfs_export_policies_rules_post_with_http_info
