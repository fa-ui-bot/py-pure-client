...
from pypureclient.flashblade._common.models.data_eviction_policies_get_response_v_2_21 import DataEvictionPoliciesGetResponse
...
from pypureclient.flashblade._common.models.data_eviction_policies_response_v_2_21 import DataEvictionPoliciesResponse
from pypureclient.flashblade._common.models.data_eviction_policy_post_v_2_21 import DataEvictionPolicyPost
from pypureclient.flashblade._common.models.data_eviction_policy_v_2_21 import DataEvictionPolicy
...
class PoliciesDataEvictionApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api221_data_eviction_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_data_eviction_policies_file_systems_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_data_eviction_policies_file_systems_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_data_eviction_policies_file_systems_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_data_eviction_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_data_eviction_policies_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_data_eviction_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api221_data_eviction_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api221_data_eviction_policies_delete_with_http_info = data_eviction_policies_delete_with_http_info
    api221_data_eviction_policies_file_systems_delete_with_http_info = data_eviction_policies_file_systems_delete_with_http_info
    api221_data_eviction_policies_file_systems_get_with_http_info = data_eviction_policies_file_systems_get_with_http_info
    api221_data_eviction_policies_file_systems_post_with_http_info = data_eviction_policies_file_systems_post_with_http_info
    api221_data_eviction_policies_get_with_http_info = data_eviction_policies_get_with_http_info
    api221_data_eviction_policies_members_get_with_http_info = data_eviction_policies_members_get_with_http_info
    api221_data_eviction_policies_patch_with_http_info = data_eviction_policies_patch_with_http_info
    api221_data_eviction_policies_post_with_http_info = data_eviction_policies_post_with_http_info
