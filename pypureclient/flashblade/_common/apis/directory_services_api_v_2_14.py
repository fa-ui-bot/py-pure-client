...
from pypureclient.flashblade._common.models.directory_service_roles_get_response_v_2_14 import DirectoryServiceRolesGetResponse
from pypureclient.flashblade._common.models.directory_service_roles_response_v_2_14 import DirectoryServiceRolesResponse
...
class DirectoryServicesApi:
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_directory_services_roles_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_directory_services_roles_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_directory_services_test_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api214_directory_services_get_with_http_info = directory_services_get_with_http_info
    api214_directory_services_patch_with_http_info = directory_services_patch_with_http_info
    api214_directory_services_roles_delete_with_http_info = directory_services_roles_delete_with_http_info
    api214_directory_services_roles_get_with_http_info = directory_services_roles_get_with_http_info
    api214_directory_services_roles_patch_with_http_info = directory_services_roles_patch_with_http_info
    api214_directory_services_roles_post_with_http_info = directory_services_roles_post_with_http_info
    api214_directory_services_test_get_with_http_info = directory_services_test_get_with_http_info
    api214_directory_services_test_patch_with_http_info = directory_services_test_patch_with_http_info
    api215_directory_services_get_with_http_info = directory_services_get_with_http_info
    api215_directory_services_patch_with_http_info = directory_services_patch_with_http_info
    api215_directory_services_roles_delete_with_http_info = directory_services_roles_delete_with_http_info
    api215_directory_services_roles_get_with_http_info = directory_services_roles_get_with_http_info
    api215_directory_services_roles_patch_with_http_info = directory_services_roles_patch_with_http_info
    api215_directory_services_roles_post_with_http_info = directory_services_roles_post_with_http_info
    api215_directory_services_test_get_with_http_info = directory_services_test_get_with_http_info
    api215_directory_services_test_patch_with_http_info = directory_services_test_patch_with_http_info
    api216_directory_services_get_with_http_info = directory_services_get_with_http_info
    api216_directory_services_patch_with_http_info = directory_services_patch_with_http_info
    api216_directory_services_roles_delete_with_http_info = directory_services_roles_delete_with_http_info
    api216_directory_services_roles_get_with_http_info = directory_services_roles_get_with_http_info
    api216_directory_services_roles_patch_with_http_info = directory_services_roles_patch_with_http_info
    api216_directory_services_roles_post_with_http_info = directory_services_roles_post_with_http_info
    api216_directory_services_test_get_with_http_info = directory_services_test_get_with_http_info
    api216_directory_services_test_patch_with_http_info = directory_services_test_patch_with_http_info
