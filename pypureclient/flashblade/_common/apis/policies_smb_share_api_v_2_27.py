...
from pypureclient.flashblade._common.models.smb_share_policy_get_response_v_2_25 import SmbSharePolicyGetResponse
from pypureclient.flashblade._common.models.smb_share_policy_patch_v_2_25 import SmbSharePolicyPatch
from pypureclient.flashblade._common.models.smb_share_policy_post_v_2_25 import SmbSharePolicyPost
from pypureclient.flashblade._common.models.smb_share_policy_response_v_2_25 import SmbSharePolicyResponse
...
class PoliciesSMBShareApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_smb_share_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_smb_share_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_smb_share_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_smb_share_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_smb_share_policies_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_smb_share_policies_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_smb_share_policies_rules_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_smb_share_policies_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api227_smb_share_policies_delete_with_http_info = smb_share_policies_delete_with_http_info
    api227_smb_share_policies_get_with_http_info = smb_share_policies_get_with_http_info
    api227_smb_share_policies_patch_with_http_info = smb_share_policies_patch_with_http_info
    api227_smb_share_policies_post_with_http_info = smb_share_policies_post_with_http_info
    api227_smb_share_policies_rules_delete_with_http_info = smb_share_policies_rules_delete_with_http_info
    api227_smb_share_policies_rules_get_with_http_info = smb_share_policies_rules_get_with_http_info
    api227_smb_share_policies_rules_patch_with_http_info = smb_share_policies_rules_patch_with_http_info
    api227_smb_share_policies_rules_post_with_http_info = smb_share_policies_rules_post_with_http_info
    api228_smb_share_policies_delete_with_http_info = smb_share_policies_delete_with_http_info
    api228_smb_share_policies_get_with_http_info = smb_share_policies_get_with_http_info
    api228_smb_share_policies_patch_with_http_info = smb_share_policies_patch_with_http_info
    api228_smb_share_policies_post_with_http_info = smb_share_policies_post_with_http_info
    api228_smb_share_policies_rules_delete_with_http_info = smb_share_policies_rules_delete_with_http_info
    api228_smb_share_policies_rules_get_with_http_info = smb_share_policies_rules_get_with_http_info
    api228_smb_share_policies_rules_patch_with_http_info = smb_share_policies_rules_patch_with_http_info
    api228_smb_share_policies_rules_post_with_http_info = smb_share_policies_rules_post_with_http_info
