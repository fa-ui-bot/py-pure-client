...
from pypureclient.flashblade._common.models.legal_hold_v_2_24 import LegalHold
from pypureclient.flashblade._common.models.legal_holds_get_response_v_2_24 import LegalHoldsGetResponse
from pypureclient.flashblade._common.models.legal_holds_held_entities_get_response_v_2_22 import LegalHoldsHeldEntitiesGetResponse
from pypureclient.flashblade._common.models.legal_holds_held_entities_response_v_2_22 import LegalHoldsHeldEntitiesResponse
from pypureclient.flashblade._common.models.legal_holds_response_v_2_24 import LegalHoldsResponse
...
class LegalHoldsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_legal_holds_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_legal_holds_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_legal_holds_held_entities_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_legal_holds_held_entities_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_legal_holds_held_entities_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_legal_holds_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_legal_holds_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api227_legal_holds_delete_with_http_info = legal_holds_delete_with_http_info
    api227_legal_holds_get_with_http_info = legal_holds_get_with_http_info
    api227_legal_holds_held_entities_get_with_http_info = legal_holds_held_entities_get_with_http_info
    api227_legal_holds_held_entities_patch_with_http_info = legal_holds_held_entities_patch_with_http_info
    api227_legal_holds_held_entities_post_with_http_info = legal_holds_held_entities_post_with_http_info
    api227_legal_holds_patch_with_http_info = legal_holds_patch_with_http_info
    api227_legal_holds_post_with_http_info = legal_holds_post_with_http_info
    api228_legal_holds_delete_with_http_info = legal_holds_delete_with_http_info
    api228_legal_holds_get_with_http_info = legal_holds_get_with_http_info
    api228_legal_holds_held_entities_get_with_http_info = legal_holds_held_entities_get_with_http_info
    api228_legal_holds_held_entities_patch_with_http_info = legal_holds_held_entities_patch_with_http_info
