...
from pypureclient.flashblade._common.models.file_system_replica_link_get_response_v_2_17 import FileSystemReplicaLinkGetResponse
from pypureclient.flashblade._common.models.file_system_replica_link_response_v_2_17 import FileSystemReplicaLinkResponse
from pypureclient.flashblade._common.models.file_system_replica_link_v_2_17 import FileSystemReplicaLink
from pypureclient.flashblade._common.models.file_system_snapshot_get_transfer_response_v_2_17 import FileSystemSnapshotGetTransferResponse
...
class FileSystemReplicaLinksApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api217_file_system_replica_links_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_file_system_replica_links_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_file_system_replica_links_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_file_system_replica_links_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_file_system_replica_links_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_file_system_replica_links_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_file_system_replica_links_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_file_system_replica_links_transfer_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api217_file_system_replica_links_delete_with_http_info = file_system_replica_links_delete_with_http_info
    api217_file_system_replica_links_get_with_http_info = file_system_replica_links_get_with_http_info
    api217_file_system_replica_links_patch_with_http_info = file_system_replica_links_patch_with_http_info
    api217_file_system_replica_links_policies_delete_with_http_info = file_system_replica_links_policies_delete_with_http_info
    api217_file_system_replica_links_policies_get_with_http_info = file_system_replica_links_policies_get_with_http_info
    api217_file_system_replica_links_policies_post_with_http_info = file_system_replica_links_policies_post_with_http_info
    api217_file_system_replica_links_post_with_http_info = file_system_replica_links_post_with_http_info
    api217_file_system_replica_links_transfer_get_with_http_info = file_system_replica_links_transfer_get_with_http_info
    api218_file_system_replica_links_delete_with_http_info = file_system_replica_links_delete_with_http_info
    api218_file_system_replica_links_get_with_http_info = file_system_replica_links_get_with_http_info
    api218_file_system_replica_links_patch_with_http_info = file_system_replica_links_patch_with_http_info
    api218_file_system_replica_links_policies_delete_with_http_info = file_system_replica_links_policies_delete_with_http_info
    api218_file_system_replica_links_policies_get_with_http_info = file_system_replica_links_policies_get_with_http_info
    api218_file_system_replica_links_policies_post_with_http_info = file_system_replica_links_policies_post_with_http_info
    api218_file_system_replica_links_post_with_http_info = file_system_replica_links_post_with_http_info
    api218_file_system_replica_links_transfer_get_with_http_info = file_system_replica_links_transfer_get_with_http_info
    api219_file_system_replica_links_delete_with_http_info = file_system_replica_links_delete_with_http_info
    api219_file_system_replica_links_get_with_http_info = file_system_replica_links_get_with_http_info
    api219_file_system_replica_links_patch_with_http_info = file_system_replica_links_patch_with_http_info
    api219_file_system_replica_links_policies_delete_with_http_info = file_system_replica_links_policies_delete_with_http_info
    api219_file_system_replica_links_policies_get_with_http_info = file_system_replica_links_policies_get_with_http_info
    api219_file_system_replica_links_policies_post_with_http_info = file_system_replica_links_policies_post_with_http_info
    api219_file_system_replica_links_post_with_http_info = file_system_replica_links_post_with_http_info
    api219_file_system_replica_links_transfer_get_with_http_info = file_system_replica_links_transfer_get_with_http_info
    api220_file_system_replica_links_delete_with_http_info = file_system_replica_links_delete_with_http_info
    api220_file_system_replica_links_get_with_http_info = file_system_replica_links_get_with_http_info
    api220_file_system_replica_links_patch_with_http_info = file_system_replica_links_patch_with_http_info
    api220_file_system_replica_links_policies_delete_with_http_info = file_system_replica_links_policies_delete_with_http_info
    api220_file_system_replica_links_policies_get_with_http_info = file_system_replica_links_policies_get_with_http_info
    api220_file_system_replica_links_policies_post_with_http_info = file_system_replica_links_policies_post_with_http_info
    api220_file_system_replica_links_post_with_http_info = file_system_replica_links_post_with_http_info
    api220_file_system_replica_links_transfer_get_with_http_info = file_system_replica_links_transfer_get_with_http_info
    api221_file_system_replica_links_delete_with_http_info = file_system_replica_links_delete_with_http_info
    api221_file_system_replica_links_get_with_http_info = file_system_replica_links_get_with_http_info
    api221_file_system_replica_links_patch_with_http_info = file_system_replica_links_patch_with_http_info
    api221_file_system_replica_links_policies_delete_with_http_info = file_system_replica_links_policies_delete_with_http_info
    api221_file_system_replica_links_policies_get_with_http_info = file_system_replica_links_policies_get_with_http_info
    api221_file_system_replica_links_policies_post_with_http_info = file_system_replica_links_policies_post_with_http_info
    api221_file_system_replica_links_post_with_http_info = file_system_replica_links_post_with_http_info
    api221_file_system_replica_links_transfer_get_with_http_info = file_system_replica_links_transfer_get_with_http_info
