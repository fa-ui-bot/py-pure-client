...
from pypureclient.flashblade._common.models.hardware_get_response_v_2_0 import HardwareGetResponse
from pypureclient.flashblade._common.models.hardware_response_v_2_0 import HardwareResponse
...
class HardwareApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api20_hardware_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_hardware_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api20_hardware_get_with_http_info = hardware_get_with_http_info
    api20_hardware_patch_with_http_info = hardware_patch_with_http_info
    api21_hardware_get_with_http_info = hardware_get_with_http_info
    api21_hardware_patch_with_http_info = hardware_patch_with_http_info
    ...
    api212_hardware_get_with_http_info = hardware_get_with_http_info
    api212_hardware_patch_with_http_info = hardware_patch_with_http_info
