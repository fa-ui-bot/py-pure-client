...
from pypureclient.flashblade._common.models.session_get_response_v_2_3 import SessionGetResponse
...
class SessionsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api23_sessions_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    api212_sessions_get_with_http_info = sessions_get_with_http_info
    api213_sessions_get_with_http_info = sessions_get_with_http_info
    api23_sessions_get_with_http_info = sessions_get_with_http_info
