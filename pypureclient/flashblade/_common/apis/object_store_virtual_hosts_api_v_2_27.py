...
from pypureclient.flashblade._common.models.object_store_virtual_host_get_response_v_2_24 import ObjectStoreVirtualHostGetResponse
from pypureclient.flashblade._common.models.object_store_virtual_host_patch_v_2_22 import ObjectStoreVirtualHostPatch
from pypureclient.flashblade._common.models.object_store_virtual_host_response_v_2_24 import ObjectStoreVirtualHostResponse
from pypureclient.flashblade._common.models.object_store_virtual_host_v_2_24 import ObjectStoreVirtualHost
...
class ObjectStoreVirtualHostsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_object_store_virtual_hosts_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_object_store_virtual_hosts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_object_store_virtual_hosts_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_object_store_virtual_hosts_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api227_object_store_virtual_hosts_delete_with_http_info = object_store_virtual_hosts_delete_with_http_info
    api227_object_store_virtual_hosts_get_with_http_info = object_store_virtual_hosts_get_with_http_info
    api227_object_store_virtual_hosts_patch_with_http_info = object_store_virtual_hosts_patch_with_http_info
    api227_object_store_virtual_hosts_post_with_http_info = object_store_virtual_hosts_post_with_http_info
    api228_object_store_virtual_hosts_delete_with_http_info = object_store_virtual_hosts_delete_with_http_info
    api228_object_store_virtual_hosts_get_with_http_info = object_store_virtual_hosts_get_with_http_info
    api228_object_store_virtual_hosts_patch_with_http_info = object_store_virtual_hosts_patch_with_http_info
    api228_object_store_virtual_hosts_post_with_http_info = object_store_virtual_hosts_post_with_http_info
