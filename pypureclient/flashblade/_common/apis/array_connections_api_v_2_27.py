...
class ArrayConnectionsApi:
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_array_connections_connection_key_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_array_connections_performance_replication_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    api227_array_connections_connection_key_post_with_http_info = array_connections_connection_key_post_with_http_info
    ...
    api227_array_connections_performance_replication_get_with_http_info = array_connections_performance_replication_get_with_http_info
    ...
    api228_array_connections_connection_key_post_with_http_info = array_connections_connection_key_post_with_http_info
    ...
    api228_array_connections_performance_replication_get_with_http_info = array_connections_performance_replication_get_with_http_info
