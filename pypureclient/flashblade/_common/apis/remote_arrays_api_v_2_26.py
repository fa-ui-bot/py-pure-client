...
from pypureclient.flashblade._common.models.remote_array_response_v_2_26 import RemoteArrayResponse
from pypureclient.flashblade._common.models.remote_arrays_response_v_2_26 import RemoteArraysResponse
...
class RemoteArraysApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api226_remote_arrays_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def remote_arrays_patch_with_http_info(
        ...
        ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        names: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the unique names specified. Enter multiple names in comma-separated format. For example, `name01,name02`. If there is not at least one resource that matches each of the elements of `names`, then an error is returned, except when creating new resources.")] = None,
        to_topology_group_ids: Annotated[Optional[conlist(StrictStr)], Field(description="Moves selected remote array to the specified topology group by ID. One of the `to_topology_group_ids` or `to_topology_group_names` parameters is required, but they cannot be set together.")] = None,
        to_topology_group_names: Annotated[Optional[conlist(StrictStr)], Field(description="Moves selected remote array to the specified topology group by name. One of the `to_topology_group_ids` or `to_topology_group_names` parameters is required, but they cannot be set together.")] = None,
        **kwargs
    ) -> ApiResponse:  # noqa: E501
        ...
        :param names: Performs the operation on the unique names specified. Enter multiple names in comma-separated format. For example, `name01,name02`. If there is not at least one resource that matches each of the elements of `names`, then an error is returned, except when creating new resources.
        :type names: List[str]
        :param to_topology_group_ids: Moves selected remote array to the specified topology group by ID. One of the `to_topology_group_ids` or `to_topology_group_names` parameters is required, but they cannot be set together.
        :type to_topology_group_ids: List[str]
        :param to_topology_group_names: Moves selected remote array to the specified topology group by name. One of the `to_topology_group_ids` or `to_topology_group_names` parameters is required, but they cannot be set together.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api226_remote_arrays_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api226_remote_arrays_get_with_http_info = remote_arrays_get_with_http_info
    api226_remote_arrays_patch_with_http_info = remote_arrays_patch_with_http_info
