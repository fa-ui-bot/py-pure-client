...
from pypureclient.flashblade._common.models.hardware_get_response_v_2_8 import HardwareGetResponse
from pypureclient.flashblade._common.models.hardware_response_v_2_8 import HardwareResponse
from pypureclient.flashblade._common.models.hardware_v_2_8 import Hardware
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api214_hardware_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_hardware_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
