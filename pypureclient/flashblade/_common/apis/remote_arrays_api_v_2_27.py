...
from pypureclient.flashblade._common.models.remote_array_response_v_2_27 import RemoteArrayResponse
from pypureclient.flashblade._common.models.remote_arrays_response_v_2_27 import RemoteArraysResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_remote_arrays_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_remote_arrays_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
