...
class KeytabsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api214_keytabs_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_keytabs_download_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_keytabs_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_keytabs_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_keytabs_upload_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api214_keytabs_delete_with_http_info = keytabs_delete_with_http_info
    api214_keytabs_download_get_with_http_info = keytabs_download_get_with_http_info
    api214_keytabs_get_with_http_info = keytabs_get_with_http_info
    api214_keytabs_post_with_http_info = keytabs_post_with_http_info
    api214_keytabs_upload_post_with_http_info = keytabs_upload_post_with_http_info
    api215_keytabs_delete_with_http_info = keytabs_delete_with_http_info
    api215_keytabs_download_get_with_http_info = keytabs_download_get_with_http_info
    api215_keytabs_get_with_http_info = keytabs_get_with_http_info
    api215_keytabs_post_with_http_info = keytabs_post_with_http_info
    api215_keytabs_upload_post_with_http_info = keytabs_upload_post_with_http_info
    api216_keytabs_delete_with_http_info = keytabs_delete_with_http_info
    api216_keytabs_download_get_with_http_info = keytabs_download_get_with_http_info
    api216_keytabs_get_with_http_info = keytabs_get_with_http_info
    api216_keytabs_post_with_http_info = keytabs_post_with_http_info
    api216_keytabs_upload_post_with_http_info = keytabs_upload_post_with_http_info
