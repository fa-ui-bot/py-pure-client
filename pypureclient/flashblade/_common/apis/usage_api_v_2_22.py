...
class UsageApi:
    ...
    # Method Aliases
    api222_usage_groups_get_with_http_info = usage_groups_get_with_http_info
    api222_usage_users_get_with_http_info = usage_users_get_with_http_info
    api223_usage_groups_get_with_http_info = usage_groups_get_with_http_info
    api223_usage_users_get_with_http_info = usage_users_get_with_http_info
