...
from pypureclient.flashblade._common.models.bucket_access_policy_get_response_v_2_25 import BucketAccessPolicyGetResponse
from pypureclient.flashblade._common.models.bucket_access_policy_post_v_2_12 import BucketAccessPolicyPost
from pypureclient.flashblade._common.models.bucket_access_policy_response_v_2_25 import BucketAccessPolicyResponse
...
from pypureclient.flashblade._common.models.bucket_patch_v_2_26 import BucketPatch
from pypureclient.flashblade._common.models.bucket_performance_get_response_v_2_21 import BucketPerformanceGetResponse
from pypureclient.flashblade._common.models.bucket_post_v_2_26 import BucketPost
...
from pypureclient.flashblade._common.models.cross_origin_resource_sharing_policy_get_response_v_2_25 import CrossOriginResourceSharingPolicyGetResponse
...
from pypureclient.flashblade._common.models.cross_origin_resource_sharing_policy_response_v_2_25 import CrossOriginResourceSharingPolicyResponse
...
class BucketsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_bucket_audit_filter_actions_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_buckets_audit_filters_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_buckets_audit_filters_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_buckets_audit_filters_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_buckets_audit_filters_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_buckets_bucket_access_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_buckets_bucket_access_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_buckets_bucket_access_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_buckets_bucket_access_policies_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_buckets_bucket_access_policies_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_buckets_bucket_access_policies_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_buckets_cross_origin_resource_sharing_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_buckets_cross_origin_resource_sharing_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_buckets_cross_origin_resource_sharing_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_buckets_cross_origin_resource_sharing_policies_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_buckets_cross_origin_resource_sharing_policies_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_buckets_cross_origin_resource_sharing_policies_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_buckets_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_buckets_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_buckets_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_buckets_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_buckets_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_buckets_s3_specific_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api227_bucket_audit_filter_actions_get_with_http_info = bucket_audit_filter_actions_get_with_http_info
    api227_buckets_audit_filters_delete_with_http_info = buckets_audit_filters_delete_with_http_info
    api227_buckets_audit_filters_get_with_http_info = buckets_audit_filters_get_with_http_info
    api227_buckets_audit_filters_patch_with_http_info = buckets_audit_filters_patch_with_http_info
    api227_buckets_audit_filters_post_with_http_info = buckets_audit_filters_post_with_http_info
    api227_buckets_bucket_access_policies_delete_with_http_info = buckets_bucket_access_policies_delete_with_http_info
    api227_buckets_bucket_access_policies_get_with_http_info = buckets_bucket_access_policies_get_with_http_info
    api227_buckets_bucket_access_policies_post_with_http_info = buckets_bucket_access_policies_post_with_http_info
    api227_buckets_bucket_access_policies_rules_delete_with_http_info = buckets_bucket_access_policies_rules_delete_with_http_info
    api227_buckets_bucket_access_policies_rules_get_with_http_info = buckets_bucket_access_policies_rules_get_with_http_info
    api227_buckets_bucket_access_policies_rules_post_with_http_info = buckets_bucket_access_policies_rules_post_with_http_info
    api227_buckets_cross_origin_resource_sharing_policies_delete_with_http_info = buckets_cross_origin_resource_sharing_policies_delete_with_http_info
    api227_buckets_cross_origin_resource_sharing_policies_get_with_http_info = buckets_cross_origin_resource_sharing_policies_get_with_http_info
    api227_buckets_cross_origin_resource_sharing_policies_post_with_http_info = buckets_cross_origin_resource_sharing_policies_post_with_http_info
    api227_buckets_cross_origin_resource_sharing_policies_rules_delete_with_http_info = buckets_cross_origin_resource_sharing_policies_rules_delete_with_http_info
    api227_buckets_cross_origin_resource_sharing_policies_rules_get_with_http_info = buckets_cross_origin_resource_sharing_policies_rules_get_with_http_info
    api227_buckets_cross_origin_resource_sharing_policies_rules_post_with_http_info = buckets_cross_origin_resource_sharing_policies_rules_post_with_http_info
    api227_buckets_delete_with_http_info = buckets_delete_with_http_info
    api227_buckets_get_with_http_info = buckets_get_with_http_info
    api227_buckets_patch_with_http_info = buckets_patch_with_http_info
    api227_buckets_performance_get_with_http_info = buckets_performance_get_with_http_info
    api227_buckets_post_with_http_info = buckets_post_with_http_info
    api227_buckets_s3_specific_performance_get_with_http_info = buckets_s3_specific_performance_get_with_http_info
    api228_bucket_audit_filter_actions_get_with_http_info = bucket_audit_filter_actions_get_with_http_info
    api228_buckets_audit_filters_delete_with_http_info = buckets_audit_filters_delete_with_http_info
    api228_buckets_audit_filters_get_with_http_info = buckets_audit_filters_get_with_http_info
    api228_buckets_audit_filters_patch_with_http_info = buckets_audit_filters_patch_with_http_info
    api228_buckets_audit_filters_post_with_http_info = buckets_audit_filters_post_with_http_info
    api228_buckets_bucket_access_policies_delete_with_http_info = buckets_bucket_access_policies_delete_with_http_info
    api228_buckets_bucket_access_policies_get_with_http_info = buckets_bucket_access_policies_get_with_http_info
    api228_buckets_bucket_access_policies_post_with_http_info = buckets_bucket_access_policies_post_with_http_info
    api228_buckets_bucket_access_policies_rules_delete_with_http_info = buckets_bucket_access_policies_rules_delete_with_http_info
    api228_buckets_bucket_access_policies_rules_get_with_http_info = buckets_bucket_access_policies_rules_get_with_http_info
    api228_buckets_bucket_access_policies_rules_post_with_http_info = buckets_bucket_access_policies_rules_post_with_http_info
    api228_buckets_cross_origin_resource_sharing_policies_delete_with_http_info = buckets_cross_origin_resource_sharing_policies_delete_with_http_info
    api228_buckets_cross_origin_resource_sharing_policies_get_with_http_info = buckets_cross_origin_resource_sharing_policies_get_with_http_info
    api228_buckets_cross_origin_resource_sharing_policies_post_with_http_info = buckets_cross_origin_resource_sharing_policies_post_with_http_info
    api228_buckets_cross_origin_resource_sharing_policies_rules_delete_with_http_info = buckets_cross_origin_resource_sharing_policies_rules_delete_with_http_info
    api228_buckets_cross_origin_resource_sharing_policies_rules_get_with_http_info = buckets_cross_origin_resource_sharing_policies_rules_get_with_http_info
    api228_buckets_cross_origin_resource_sharing_policies_rules_post_with_http_info = buckets_cross_origin_resource_sharing_policies_rules_post_with_http_info
    api228_buckets_delete_with_http_info = buckets_delete_with_http_info
    api228_buckets_get_with_http_info = buckets_get_with_http_info
    api228_buckets_patch_with_http_info = buckets_patch_with_http_info
    api228_buckets_performance_get_with_http_info = buckets_performance_get_with_http_info
    api228_buckets_post_with_http_info = buckets_post_with_http_info
    api228_buckets_s3_specific_performance_get_with_http_info = buckets_s3_specific_performance_get_with_http_info
