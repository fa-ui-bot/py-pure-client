...
from pypureclient.flashblade._common.models.node_get_response_v_2_23 import NodeGetResponse
from pypureclient.flashblade._common.models.node_response_v_2_23 import NodeResponse
...
class NodesApi:
    ...
    def nodes_batch_post_with_http_info(
        self,
        items: conlist(Node),
        ...
        add_to_groups: Annotated[Optional[StrictBool], Field(description="If `true`, the node being added will automatically be added to all node groups that other members of its resiliency group already belong to. This parameter must be set to `true` when adding any node that will be part of a resiliency group.")] = None,
        **kwargs
        ...
        :param add_to_groups: If `true`, the node being added will automatically be added to all node groups that other members of its resiliency group already belong to. This parameter must be set to `true` when adding any node that will be part of a resiliency group.
        :type add_to_groups: bool
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api223_nodes_batch_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _query_params = []
        if _params.get('add_to_groups') is not None:  # noqa: E501
            _query_params.append(('add_to_groups', _params['add_to_groups']))
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/nodes/batch', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_nodes_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def nodes_patch_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        names: Annotated[Optional[conlist(StrictStr)], Field(description="Performs the operation on the unique names specified. Enter multiple names in comma-separated format. For example, `name01,name02`. If there is not at least one resource that matches each of the elements of `names`, then an error is returned, except when creating new resources.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api223_nodes_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/nodes', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    # Method Aliases
    api223_nodes_batch_post_with_http_info = nodes_batch_post_with_http_info
    api223_nodes_get_with_http_info = nodes_get_with_http_info
    api223_nodes_patch_with_http_info = nodes_patch_with_http_info
    api224_nodes_batch_post_with_http_info = nodes_batch_post_with_http_info
    api224_nodes_get_with_http_info = nodes_get_with_http_info
    api224_nodes_patch_with_http_info = nodes_patch_with_http_info
    api225_nodes_batch_post_with_http_info = nodes_batch_post_with_http_info
    api225_nodes_get_with_http_info = nodes_get_with_http_info
    api225_nodes_patch_with_http_info = nodes_patch_with_http_info
    api226_nodes_batch_post_with_http_info = nodes_batch_post_with_http_info
    api226_nodes_get_with_http_info = nodes_get_with_http_info
    api226_nodes_patch_with_http_info = nodes_patch_with_http_info
