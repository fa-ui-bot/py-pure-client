...
from pypureclient.flashblade._common.models.network_interface_get_response_v_2_28 import NetworkInterfaceGetResponse
...
from pypureclient.flashblade._common.models.network_interface_patch_v_2_28 import NetworkInterfacePatch
...
from pypureclient.flashblade._common.models.network_interface_post_v_2_28 import NetworkInterfacePost
from pypureclient.flashblade._common.models.network_interface_response_v_2_28 import NetworkInterfaceResponse
...
from pypureclient.flashblade._common.models.network_interfaces_connectors_performance_get_response_v_2_22 import NetworkInterfacesConnectorsPerformanceGetResponse
...
class NetworkInterfacesApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api228_network_interfaces_connectors_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_network_interfaces_connectors_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_network_interfaces_connectors_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_network_interfaces_connectors_settings_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_network_interfaces_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_network_interfaces_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_network_interfaces_neighbors_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_network_interfaces_network_connection_statistics_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_network_interfaces_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_network_interfaces_ping_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def network_interfaces_post_with_http_info(
        ...
        network_interface: NetworkInterfacePost,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        **kwargs
    ) -> ApiResponse:  # noqa: E501
        ...
        :type names: List[str]
        :param network_interface: (required)
        :type network_interface: NetworkInterfacePost
        :param x_request_id: Supplied by client during request or generated by server.
        :type x_request_id: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_network_interfaces_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_network_interfaces_trace_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api228_network_interfaces_connectors_get_with_http_info = network_interfaces_connectors_get_with_http_info
    api228_network_interfaces_connectors_patch_with_http_info = network_interfaces_connectors_patch_with_http_info
    api228_network_interfaces_connectors_performance_get_with_http_info = network_interfaces_connectors_performance_get_with_http_info
    api228_network_interfaces_connectors_settings_get_with_http_info = network_interfaces_connectors_settings_get_with_http_info
    ...
    api228_network_interfaces_network_connection_statistics_get_with_http_info = network_interfaces_network_connection_statistics_get_with_http_info
    api228_network_interfaces_patch_with_http_info = network_interfaces_patch_with_http_info
    api228_network_interfaces_ping_get_with_http_info = network_interfaces_ping_get_with_http_info
    api228_network_interfaces_post_with_http_info = network_interfaces_post_with_http_info
    api228_network_interfaces_trace_get_with_http_info = network_interfaces_trace_get_with_http_info
