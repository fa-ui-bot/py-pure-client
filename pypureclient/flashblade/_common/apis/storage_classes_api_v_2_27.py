...
from pypureclient.flashblade._common.models.storage_classes_members_get_response_v_2_27 import StorageClassesMembersGetResponse
...
class StorageClassesApi:
    ...
    def storage_classes_members_get_with_http_info(
        ...
        storage_class_names: Annotated[Optional[conlist(StrictStr)], Field(description="Selects storage classes by name. Enter multiple names in comma-separated format.")] = None,
        **kwargs
        ...
        :type sort: List[str]
        :param storage_class_names: Selects storage classes by name. Enter multiple names in comma-separated format.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_storage_classes_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
