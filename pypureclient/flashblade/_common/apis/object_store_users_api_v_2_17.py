...
from pypureclient.flashblade._common.models.object_store_user_get_response_v_2_17 import ObjectStoreUserGetResponse
from pypureclient.flashblade._common.models.object_store_user_response_v_2_17 import ObjectStoreUserResponse
...
class ObjectStoreUsersApi:
    ...
    # Method Aliases
    api217_object_store_users_delete_with_http_info = object_store_users_delete_with_http_info
    api217_object_store_users_get_with_http_info = object_store_users_get_with_http_info
    api217_object_store_users_object_store_access_policies_delete_with_http_info = object_store_users_object_store_access_policies_delete_with_http_info
    api217_object_store_users_object_store_access_policies_get_with_http_info = object_store_users_object_store_access_policies_get_with_http_info
    api217_object_store_users_object_store_access_policies_post_with_http_info = object_store_users_object_store_access_policies_post_with_http_info
    api217_object_store_users_post_with_http_info = object_store_users_post_with_http_info
    api218_object_store_users_delete_with_http_info = object_store_users_delete_with_http_info
    api218_object_store_users_get_with_http_info = object_store_users_get_with_http_info
    api218_object_store_users_object_store_access_policies_delete_with_http_info = object_store_users_object_store_access_policies_delete_with_http_info
    api218_object_store_users_object_store_access_policies_get_with_http_info = object_store_users_object_store_access_policies_get_with_http_info
    api218_object_store_users_object_store_access_policies_post_with_http_info = object_store_users_object_store_access_policies_post_with_http_info
    api218_object_store_users_post_with_http_info = object_store_users_post_with_http_info
    api219_object_store_users_delete_with_http_info = object_store_users_delete_with_http_info
    api219_object_store_users_get_with_http_info = object_store_users_get_with_http_info
    api219_object_store_users_object_store_access_policies_delete_with_http_info = object_store_users_object_store_access_policies_delete_with_http_info
    api219_object_store_users_object_store_access_policies_get_with_http_info = object_store_users_object_store_access_policies_get_with_http_info
    api219_object_store_users_object_store_access_policies_post_with_http_info = object_store_users_object_store_access_policies_post_with_http_info
    api219_object_store_users_post_with_http_info = object_store_users_post_with_http_info
    api220_object_store_users_delete_with_http_info = object_store_users_delete_with_http_info
    api220_object_store_users_get_with_http_info = object_store_users_get_with_http_info
    api220_object_store_users_object_store_access_policies_delete_with_http_info = object_store_users_object_store_access_policies_delete_with_http_info
    api220_object_store_users_object_store_access_policies_get_with_http_info = object_store_users_object_store_access_policies_get_with_http_info
    api220_object_store_users_object_store_access_policies_post_with_http_info = object_store_users_object_store_access_policies_post_with_http_info
    api220_object_store_users_post_with_http_info = object_store_users_post_with_http_info
    api221_object_store_users_delete_with_http_info = object_store_users_delete_with_http_info
    api221_object_store_users_get_with_http_info = object_store_users_get_with_http_info
    api221_object_store_users_object_store_access_policies_delete_with_http_info = object_store_users_object_store_access_policies_delete_with_http_info
    api221_object_store_users_object_store_access_policies_get_with_http_info = object_store_users_object_store_access_policies_get_with_http_info
    api221_object_store_users_object_store_access_policies_post_with_http_info = object_store_users_object_store_access_policies_post_with_http_info
    api221_object_store_users_post_with_http_info = object_store_users_post_with_http_info
