...
from pypureclient.flashblade._common.models.file_system_replica_link_get_response_v_2_28 import FileSystemReplicaLinkGetResponse
from pypureclient.flashblade._common.models.file_system_replica_link_response_v_2_28 import FileSystemReplicaLinkResponse
from pypureclient.flashblade._common.models.file_system_replica_link_v_2_28 import FileSystemReplicaLink
...
class FileSystemReplicaLinksApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api228_file_system_replica_links_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_file_system_replica_links_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_file_system_replica_links_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_file_system_replica_links_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_file_system_replica_links_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_file_system_replica_links_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_file_system_replica_links_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api228_file_system_replica_links_transfer_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api228_file_system_replica_links_delete_with_http_info = file_system_replica_links_delete_with_http_info
    api228_file_system_replica_links_get_with_http_info = file_system_replica_links_get_with_http_info
    api228_file_system_replica_links_patch_with_http_info = file_system_replica_links_patch_with_http_info
    api228_file_system_replica_links_policies_delete_with_http_info = file_system_replica_links_policies_delete_with_http_info
    api228_file_system_replica_links_policies_get_with_http_info = file_system_replica_links_policies_get_with_http_info
    api228_file_system_replica_links_policies_post_with_http_info = file_system_replica_links_policies_post_with_http_info
    api228_file_system_replica_links_post_with_http_info = file_system_replica_links_post_with_http_info
    api228_file_system_replica_links_transfer_get_with_http_info = file_system_replica_links_transfer_get_with_http_info
