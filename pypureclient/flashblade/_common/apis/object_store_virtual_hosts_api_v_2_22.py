...
from pypureclient.flashblade._common.models.object_store_virtual_host_get_response_v_2_22 import ObjectStoreVirtualHostGetResponse
from pypureclient.flashblade._common.models.object_store_virtual_host_patch_v_2_22 import ObjectStoreVirtualHostPatch
from pypureclient.flashblade._common.models.object_store_virtual_host_response_v_2_22 import ObjectStoreVirtualHostResponse
from pypureclient.flashblade._common.models.object_store_virtual_host_v_2_22 import ObjectStoreVirtualHost
...
class ObjectStoreVirtualHostsApi:
    ...
    def object_store_virtual_hosts_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/object-store-virtual-hosts', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    # Method Aliases
    api222_object_store_virtual_hosts_delete_with_http_info = object_store_virtual_hosts_delete_with_http_info
    api222_object_store_virtual_hosts_get_with_http_info = object_store_virtual_hosts_get_with_http_info
    api222_object_store_virtual_hosts_patch_with_http_info = object_store_virtual_hosts_patch_with_http_info
    api222_object_store_virtual_hosts_post_with_http_info = object_store_virtual_hosts_post_with_http_info
    api223_object_store_virtual_hosts_delete_with_http_info = object_store_virtual_hosts_delete_with_http_info
    api223_object_store_virtual_hosts_get_with_http_info = object_store_virtual_hosts_get_with_http_info
    api223_object_store_virtual_hosts_patch_with_http_info = object_store_virtual_hosts_patch_with_http_info
    api223_object_store_virtual_hosts_post_with_http_info = object_store_virtual_hosts_post_with_http_info
    api224_object_store_virtual_hosts_delete_with_http_info = object_store_virtual_hosts_delete_with_http_info
    api224_object_store_virtual_hosts_get_with_http_info = object_store_virtual_hosts_get_with_http_info
    api224_object_store_virtual_hosts_patch_with_http_info = object_store_virtual_hosts_patch_with_http_info
    api224_object_store_virtual_hosts_post_with_http_info = object_store_virtual_hosts_post_with_http_info
    api225_object_store_virtual_hosts_delete_with_http_info = object_store_virtual_hosts_delete_with_http_info
    api225_object_store_virtual_hosts_get_with_http_info = object_store_virtual_hosts_get_with_http_info
    api225_object_store_virtual_hosts_patch_with_http_info = object_store_virtual_hosts_patch_with_http_info
    api225_object_store_virtual_hosts_post_with_http_info = object_store_virtual_hosts_post_with_http_info
    api226_object_store_virtual_hosts_delete_with_http_info = object_store_virtual_hosts_delete_with_http_info
    api226_object_store_virtual_hosts_get_with_http_info = object_store_virtual_hosts_get_with_http_info
    api226_object_store_virtual_hosts_patch_with_http_info = object_store_virtual_hosts_patch_with_http_info
    api226_object_store_virtual_hosts_post_with_http_info = object_store_virtual_hosts_post_with_http_info
