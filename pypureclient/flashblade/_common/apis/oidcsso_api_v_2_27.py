...
from pypureclient.flashblade._common.models.oidc_sso_get_response_v_2_22 import OidcSsoGetResponse
from pypureclient.flashblade._common.models.oidc_sso_patch_v_2_22 import OidcSsoPatch
from pypureclient.flashblade._common.models.oidc_sso_post_v_2_22 import OidcSsoPost
from pypureclient.flashblade._common.models.oidc_sso_response_v_2_22 import OidcSsoResponse
...
class OIDCSSOApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_sso_oidc_idps_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_sso_oidc_idps_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_sso_oidc_idps_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_sso_oidc_idps_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api227_sso_oidc_idps_delete_with_http_info = sso_oidc_idps_delete_with_http_info
