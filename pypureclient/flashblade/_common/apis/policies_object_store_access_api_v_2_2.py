...
from pypureclient.flashblade._common.models.object_store_access_policy_get_response_v_2_2 import ObjectStoreAccessPolicyGetResponse
...
from pypureclient.flashblade._common.models.object_store_access_policy_response_v_2_2 import ObjectStoreAccessPolicyResponse
...
class PoliciesObjectStoreAccessApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api22_object_store_access_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_object_store_access_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_object_store_access_policies_object_store_users_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_object_store_access_policies_object_store_users_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_object_store_access_policies_object_store_users_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_object_store_access_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_object_store_access_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_object_store_access_policies_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_object_store_access_policies_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_object_store_access_policies_rules_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_object_store_access_policies_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_object_store_access_policy_actions_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api22_object_store_access_policies_delete_with_http_info = object_store_access_policies_delete_with_http_info
    api22_object_store_access_policies_get_with_http_info = object_store_access_policies_get_with_http_info
    api22_object_store_access_policies_object_store_users_delete_with_http_info = object_store_access_policies_object_store_users_delete_with_http_info
    api22_object_store_access_policies_object_store_users_get_with_http_info = object_store_access_policies_object_store_users_get_with_http_info
    api22_object_store_access_policies_object_store_users_post_with_http_info = object_store_access_policies_object_store_users_post_with_http_info
    api22_object_store_access_policies_patch_with_http_info = object_store_access_policies_patch_with_http_info
    api22_object_store_access_policies_post_with_http_info = object_store_access_policies_post_with_http_info
    api22_object_store_access_policies_rules_delete_with_http_info = object_store_access_policies_rules_delete_with_http_info
    api22_object_store_access_policies_rules_get_with_http_info = object_store_access_policies_rules_get_with_http_info
    api22_object_store_access_policies_rules_patch_with_http_info = object_store_access_policies_rules_patch_with_http_info
    api22_object_store_access_policies_rules_post_with_http_info = object_store_access_policies_rules_post_with_http_info
    api22_object_store_access_policy_actions_get_with_http_info = object_store_access_policy_actions_get_with_http_info
    api23_object_store_access_policies_delete_with_http_info = object_store_access_policies_delete_with_http_info
    api23_object_store_access_policies_get_with_http_info = object_store_access_policies_get_with_http_info
    api23_object_store_access_policies_object_store_users_delete_with_http_info = object_store_access_policies_object_store_users_delete_with_http_info
    api23_object_store_access_policies_object_store_users_get_with_http_info = object_store_access_policies_object_store_users_get_with_http_info
    api23_object_store_access_policies_object_store_users_post_with_http_info = object_store_access_policies_object_store_users_post_with_http_info
    api23_object_store_access_policies_patch_with_http_info = object_store_access_policies_patch_with_http_info
    api23_object_store_access_policies_post_with_http_info = object_store_access_policies_post_with_http_info
    api23_object_store_access_policies_rules_delete_with_http_info = object_store_access_policies_rules_delete_with_http_info
    api23_object_store_access_policies_rules_get_with_http_info = object_store_access_policies_rules_get_with_http_info
    api23_object_store_access_policies_rules_patch_with_http_info = object_store_access_policies_rules_patch_with_http_info
    api23_object_store_access_policies_rules_post_with_http_info = object_store_access_policies_rules_post_with_http_info
    api23_object_store_access_policy_actions_get_with_http_info = object_store_access_policy_actions_get_with_http_info
