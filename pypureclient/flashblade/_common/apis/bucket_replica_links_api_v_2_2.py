...
from pypureclient.flashblade._common.models.bucket_replica_link_get_response_v_2_2 import BucketReplicaLinkGetResponse
from pypureclient.flashblade._common.models.bucket_replica_link_post_v_2_2 import BucketReplicaLinkPost
from pypureclient.flashblade._common.models.bucket_replica_link_response_v_2_2 import BucketReplicaLinkResponse
from pypureclient.flashblade._common.models.bucket_replica_link_v_2_2 import BucketReplicaLink
...
class BucketReplicaLinksApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api22_bucket_replica_links_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_bucket_replica_links_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_bucket_replica_links_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api22_bucket_replica_links_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api210_bucket_replica_links_delete_with_http_info = bucket_replica_links_delete_with_http_info
    api210_bucket_replica_links_get_with_http_info = bucket_replica_links_get_with_http_info
    api210_bucket_replica_links_patch_with_http_info = bucket_replica_links_patch_with_http_info
    api210_bucket_replica_links_post_with_http_info = bucket_replica_links_post_with_http_info
    api211_bucket_replica_links_delete_with_http_info = bucket_replica_links_delete_with_http_info
    api211_bucket_replica_links_get_with_http_info = bucket_replica_links_get_with_http_info
    api211_bucket_replica_links_patch_with_http_info = bucket_replica_links_patch_with_http_info
    api211_bucket_replica_links_post_with_http_info = bucket_replica_links_post_with_http_info
    api212_bucket_replica_links_delete_with_http_info = bucket_replica_links_delete_with_http_info
    api212_bucket_replica_links_get_with_http_info = bucket_replica_links_get_with_http_info
    api212_bucket_replica_links_patch_with_http_info = bucket_replica_links_patch_with_http_info
    api212_bucket_replica_links_post_with_http_info = bucket_replica_links_post_with_http_info
    api213_bucket_replica_links_delete_with_http_info = bucket_replica_links_delete_with_http_info
    api213_bucket_replica_links_get_with_http_info = bucket_replica_links_get_with_http_info
    api213_bucket_replica_links_patch_with_http_info = bucket_replica_links_patch_with_http_info
    api213_bucket_replica_links_post_with_http_info = bucket_replica_links_post_with_http_info
    api214_bucket_replica_links_delete_with_http_info = bucket_replica_links_delete_with_http_info
    api214_bucket_replica_links_get_with_http_info = bucket_replica_links_get_with_http_info
    api214_bucket_replica_links_patch_with_http_info = bucket_replica_links_patch_with_http_info
    api214_bucket_replica_links_post_with_http_info = bucket_replica_links_post_with_http_info
    api215_bucket_replica_links_delete_with_http_info = bucket_replica_links_delete_with_http_info
    api215_bucket_replica_links_get_with_http_info = bucket_replica_links_get_with_http_info
    api215_bucket_replica_links_patch_with_http_info = bucket_replica_links_patch_with_http_info
    api215_bucket_replica_links_post_with_http_info = bucket_replica_links_post_with_http_info
    api216_bucket_replica_links_delete_with_http_info = bucket_replica_links_delete_with_http_info
    api216_bucket_replica_links_get_with_http_info = bucket_replica_links_get_with_http_info
    api216_bucket_replica_links_patch_with_http_info = bucket_replica_links_patch_with_http_info
    api216_bucket_replica_links_post_with_http_info = bucket_replica_links_post_with_http_info
    api22_bucket_replica_links_delete_with_http_info = bucket_replica_links_delete_with_http_info
    api22_bucket_replica_links_get_with_http_info = bucket_replica_links_get_with_http_info
    api22_bucket_replica_links_patch_with_http_info = bucket_replica_links_patch_with_http_info
    api22_bucket_replica_links_post_with_http_info = bucket_replica_links_post_with_http_info
    api23_bucket_replica_links_delete_with_http_info = bucket_replica_links_delete_with_http_info
    api23_bucket_replica_links_get_with_http_info = bucket_replica_links_get_with_http_info
    api23_bucket_replica_links_patch_with_http_info = bucket_replica_links_patch_with_http_info
    api23_bucket_replica_links_post_with_http_info = bucket_replica_links_post_with_http_info
    api24_bucket_replica_links_delete_with_http_info = bucket_replica_links_delete_with_http_info
    api24_bucket_replica_links_get_with_http_info = bucket_replica_links_get_with_http_info
    api24_bucket_replica_links_patch_with_http_info = bucket_replica_links_patch_with_http_info
    api24_bucket_replica_links_post_with_http_info = bucket_replica_links_post_with_http_info
    api25_bucket_replica_links_delete_with_http_info = bucket_replica_links_delete_with_http_info
    api25_bucket_replica_links_get_with_http_info = bucket_replica_links_get_with_http_info
    api25_bucket_replica_links_patch_with_http_info = bucket_replica_links_patch_with_http_info
    api25_bucket_replica_links_post_with_http_info = bucket_replica_links_post_with_http_info
    api26_bucket_replica_links_delete_with_http_info = bucket_replica_links_delete_with_http_info
    api26_bucket_replica_links_get_with_http_info = bucket_replica_links_get_with_http_info
    api26_bucket_replica_links_patch_with_http_info = bucket_replica_links_patch_with_http_info
    api26_bucket_replica_links_post_with_http_info = bucket_replica_links_post_with_http_info
    api27_bucket_replica_links_delete_with_http_info = bucket_replica_links_delete_with_http_info
    api27_bucket_replica_links_get_with_http_info = bucket_replica_links_get_with_http_info
    api27_bucket_replica_links_patch_with_http_info = bucket_replica_links_patch_with_http_info
    api27_bucket_replica_links_post_with_http_info = bucket_replica_links_post_with_http_info
    api28_bucket_replica_links_delete_with_http_info = bucket_replica_links_delete_with_http_info
    api28_bucket_replica_links_get_with_http_info = bucket_replica_links_get_with_http_info
    api28_bucket_replica_links_patch_with_http_info = bucket_replica_links_patch_with_http_info
    api28_bucket_replica_links_post_with_http_info = bucket_replica_links_post_with_http_info
    api29_bucket_replica_links_delete_with_http_info = bucket_replica_links_delete_with_http_info
    api29_bucket_replica_links_get_with_http_info = bucket_replica_links_get_with_http_info
    api29_bucket_replica_links_patch_with_http_info = bucket_replica_links_patch_with_http_info
    api29_bucket_replica_links_post_with_http_info = bucket_replica_links_post_with_http_info
