...
class APIClientsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api217_api_clients_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_api_clients_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_api_clients_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_api_clients_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    api218_api_clients_delete_with_http_info = api_clients_delete_with_http_info
    api218_api_clients_get_with_http_info = api_clients_get_with_http_info
    api218_api_clients_patch_with_http_info = api_clients_patch_with_http_info
    api218_api_clients_post_with_http_info = api_clients_post_with_http_info
