...
from pypureclient.flashblade._common.models.object_store_remote_credential_get_resp_v_2_24 import ObjectStoreRemoteCredentialGetResp
...
from pypureclient.flashblade._common.models.object_store_remote_credentials_resp_v_2_24 import ObjectStoreRemoteCredentialsResp
from pypureclient.flashblade._common.models.object_store_remote_credentials_v_2_24 import ObjectStoreRemoteCredentials
...
class ObjectStoreRemoteCredentialsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_object_store_remote_credentials_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_object_store_remote_credentials_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_object_store_remote_credentials_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_object_store_remote_credentials_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api227_object_store_remote_credentials_delete_with_http_info = object_store_remote_credentials_delete_with_http_info
    api227_object_store_remote_credentials_get_with_http_info = object_store_remote_credentials_get_with_http_info
    api227_object_store_remote_credentials_patch_with_http_info = object_store_remote_credentials_patch_with_http_info
    api227_object_store_remote_credentials_post_with_http_info = object_store_remote_credentials_post_with_http_info
    api228_object_store_remote_credentials_delete_with_http_info = object_store_remote_credentials_delete_with_http_info
    api228_object_store_remote_credentials_get_with_http_info = object_store_remote_credentials_get_with_http_info
    api228_object_store_remote_credentials_patch_with_http_info = object_store_remote_credentials_patch_with_http_info
    api228_object_store_remote_credentials_post_with_http_info = object_store_remote_credentials_post_with_http_info
