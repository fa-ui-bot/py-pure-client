...
from pypureclient.flashblade._common.models.network_access_policy_get_response_v_2_25 import NetworkAccessPolicyGetResponse
from pypureclient.flashblade._common.models.network_access_policy_response_v_2_25 import NetworkAccessPolicyResponse
from pypureclient.flashblade._common.models.network_access_policy_rule_get_response_v_2_22 import NetworkAccessPolicyRuleGetResponse
from pypureclient.flashblade._common.models.network_access_policy_rule_post_v_2_13 import NetworkAccessPolicyRulePost
from pypureclient.flashblade._common.models.network_access_policy_rule_response_v_2_22 import NetworkAccessPolicyRuleResponse
from pypureclient.flashblade._common.models.network_access_policy_rule_v_2_22 import NetworkAccessPolicyRule
from pypureclient.flashblade._common.models.network_access_policy_v_2_25 import NetworkAccessPolicy
...
class PoliciesNetworkAccessApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_network_access_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_network_access_policies_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_network_access_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_network_access_policies_rules_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_network_access_policies_rules_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_network_access_policies_rules_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_network_access_policies_rules_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api227_network_access_policies_get_with_http_info = network_access_policies_get_with_http_info
    api227_network_access_policies_members_get_with_http_info = network_access_policies_members_get_with_http_info
    api227_network_access_policies_patch_with_http_info = network_access_policies_patch_with_http_info
    api227_network_access_policies_rules_delete_with_http_info = network_access_policies_rules_delete_with_http_info
    api227_network_access_policies_rules_get_with_http_info = network_access_policies_rules_get_with_http_info
    api227_network_access_policies_rules_patch_with_http_info = network_access_policies_rules_patch_with_http_info
    api227_network_access_policies_rules_post_with_http_info = network_access_policies_rules_post_with_http_info
    api228_network_access_policies_get_with_http_info = network_access_policies_get_with_http_info
    api228_network_access_policies_members_get_with_http_info = network_access_policies_members_get_with_http_info
    api228_network_access_policies_patch_with_http_info = network_access_policies_patch_with_http_info
    api228_network_access_policies_rules_delete_with_http_info = network_access_policies_rules_delete_with_http_info
    api228_network_access_policies_rules_get_with_http_info = network_access_policies_rules_get_with_http_info
    api228_network_access_policies_rules_patch_with_http_info = network_access_policies_rules_patch_with_http_info
    api228_network_access_policies_rules_post_with_http_info = network_access_policies_rules_post_with_http_info
