...
from pypureclient.flashblade._common.models.policy_base_get_response_v_2_25 import PolicyBaseGetResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_policies_all_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_policies_all_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
