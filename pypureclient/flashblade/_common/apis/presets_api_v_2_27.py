...
from pypureclient.flashblade._common.models.preset_workload_get_response_v_2_26 import PresetWorkloadGetResponse
from pypureclient.flashblade._common.models.preset_workload_patch_v_2_23 import PresetWorkloadPatch
from pypureclient.flashblade._common.models.preset_workload_post_v_2_26 import PresetWorkloadPost
from pypureclient.flashblade._common.models.preset_workload_response_v_2_26 import PresetWorkloadResponse
...
class PresetsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_presets_workload_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_presets_workload_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_presets_workload_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_presets_workload_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_presets_workload_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api227_presets_workload_delete_with_http_info = presets_workload_delete_with_http_info
    api227_presets_workload_get_with_http_info = presets_workload_get_with_http_info
    api227_presets_workload_patch_with_http_info = presets_workload_patch_with_http_info
    api227_presets_workload_post_with_http_info = presets_workload_post_with_http_info
    api227_presets_workload_put_with_http_info = presets_workload_put_with_http_info
    api228_presets_workload_delete_with_http_info = presets_workload_delete_with_http_info
    api228_presets_workload_get_with_http_info = presets_workload_get_with_http_info
