...
class HardwareConnectorsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api20_hardware_connectors_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_hardware_connectors_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api20_hardware_connectors_get_with_http_info = hardware_connectors_get_with_http_info
    api20_hardware_connectors_patch_with_http_info = hardware_connectors_patch_with_http_info
    api21_hardware_connectors_get_with_http_info = hardware_connectors_get_with_http_info
    api21_hardware_connectors_patch_with_http_info = hardware_connectors_patch_with_http_info
    api22_hardware_connectors_get_with_http_info = hardware_connectors_get_with_http_info
    api22_hardware_connectors_patch_with_http_info = hardware_connectors_patch_with_http_info
