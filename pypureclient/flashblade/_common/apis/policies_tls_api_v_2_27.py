...
from pypureclient.flashblade._common.models.tls_policy_get_response_v_2_26 import TlsPolicyGetResponse
from pypureclient.flashblade._common.models.tls_policy_post_v_2_26 import TlsPolicyPost
from pypureclient.flashblade._common.models.tls_policy_response_v_2_26 import TlsPolicyResponse
...
class PoliciesTLSApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_network_interfaces_tls_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_network_interfaces_tls_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_network_interfaces_tls_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_tls_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_tls_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_tls_policies_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_tls_policies_network_interfaces_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_tls_policies_network_interfaces_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_tls_policies_network_interfaces_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_tls_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_tls_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api227_network_interfaces_tls_policies_delete_with_http_info = network_interfaces_tls_policies_delete_with_http_info
    api227_network_interfaces_tls_policies_get_with_http_info = network_interfaces_tls_policies_get_with_http_info
    api227_network_interfaces_tls_policies_post_with_http_info = network_interfaces_tls_policies_post_with_http_info
    api227_tls_policies_delete_with_http_info = tls_policies_delete_with_http_info
    api227_tls_policies_get_with_http_info = tls_policies_get_with_http_info
    api227_tls_policies_members_get_with_http_info = tls_policies_members_get_with_http_info
    api227_tls_policies_network_interfaces_delete_with_http_info = tls_policies_network_interfaces_delete_with_http_info
    api227_tls_policies_network_interfaces_get_with_http_info = tls_policies_network_interfaces_get_with_http_info
    api227_tls_policies_network_interfaces_post_with_http_info = tls_policies_network_interfaces_post_with_http_info
    api227_tls_policies_patch_with_http_info = tls_policies_patch_with_http_info
    api227_tls_policies_post_with_http_info = tls_policies_post_with_http_info
    api228_network_interfaces_tls_policies_delete_with_http_info = network_interfaces_tls_policies_delete_with_http_info
    api228_network_interfaces_tls_policies_get_with_http_info = network_interfaces_tls_policies_get_with_http_info
    api228_network_interfaces_tls_policies_post_with_http_info = network_interfaces_tls_policies_post_with_http_info
    api228_tls_policies_delete_with_http_info = tls_policies_delete_with_http_info
    api228_tls_policies_get_with_http_info = tls_policies_get_with_http_info
    api228_tls_policies_members_get_with_http_info = tls_policies_members_get_with_http_info
    api228_tls_policies_network_interfaces_delete_with_http_info = tls_policies_network_interfaces_delete_with_http_info
    api228_tls_policies_network_interfaces_get_with_http_info = tls_policies_network_interfaces_get_with_http_info
    api228_tls_policies_network_interfaces_post_with_http_info = tls_policies_network_interfaces_post_with_http_info
    api228_tls_policies_patch_with_http_info = tls_policies_patch_with_http_info
    api228_tls_policies_post_with_http_info = tls_policies_post_with_http_info
