...
class FileSystemExportsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_file_system_exports_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_file_system_exports_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_file_system_exports_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_file_system_exports_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api227_file_system_exports_delete_with_http_info = file_system_exports_delete_with_http_info
    api227_file_system_exports_get_with_http_info = file_system_exports_get_with_http_info
    api227_file_system_exports_patch_with_http_info = file_system_exports_patch_with_http_info
    api227_file_system_exports_post_with_http_info = file_system_exports_post_with_http_info
    api228_file_system_exports_delete_with_http_info = file_system_exports_delete_with_http_info
