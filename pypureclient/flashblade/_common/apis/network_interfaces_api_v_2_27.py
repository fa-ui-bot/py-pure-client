...
from pypureclient.flashblade._common.models.network_interface_get_response_v_2_24 import NetworkInterfaceGetResponse
...
from pypureclient.flashblade._common.models.network_interface_response_v_2_24 import NetworkInterfaceResponse
...
class NetworkInterfacesApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_network_interfaces_connectors_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_network_interfaces_connectors_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_network_interfaces_connectors_performance_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_network_interfaces_connectors_settings_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_network_interfaces_network_connection_statistics_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_network_interfaces_ping_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_network_interfaces_trace_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api227_network_interfaces_connectors_get_with_http_info = network_interfaces_connectors_get_with_http_info
    api227_network_interfaces_connectors_patch_with_http_info = network_interfaces_connectors_patch_with_http_info
    api227_network_interfaces_connectors_performance_get_with_http_info = network_interfaces_connectors_performance_get_with_http_info
    api227_network_interfaces_connectors_settings_get_with_http_info = network_interfaces_connectors_settings_get_with_http_info
    ...
    api227_network_interfaces_network_connection_statistics_get_with_http_info = network_interfaces_network_connection_statistics_get_with_http_info
    api227_network_interfaces_patch_with_http_info = network_interfaces_patch_with_http_info
    api227_network_interfaces_ping_get_with_http_info = network_interfaces_ping_get_with_http_info
    api227_network_interfaces_post_with_http_info = network_interfaces_post_with_http_info
    api227_network_interfaces_trace_get_with_http_info = network_interfaces_trace_get_with_http_info
