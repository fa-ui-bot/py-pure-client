...
from pypureclient.flashblade._common.models.policy_base_get_response_v_2_14 import PolicyBaseGetResponse
...
class PoliciesAllApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api214_policies_all_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_policies_all_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api214_policies_all_get_with_http_info = policies_all_get_with_http_info
    api214_policies_all_members_get_with_http_info = policies_all_members_get_with_http_info
    api215_policies_all_get_with_http_info = policies_all_get_with_http_info
    api215_policies_all_members_get_with_http_info = policies_all_members_get_with_http_info
    api216_policies_all_get_with_http_info = policies_all_get_with_http_info
    api216_policies_all_members_get_with_http_info = policies_all_members_get_with_http_info
