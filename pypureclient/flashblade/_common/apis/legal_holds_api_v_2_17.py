...
from pypureclient.flashblade._common.models.legal_hold_v_2_17 import LegalHold
from pypureclient.flashblade._common.models.legal_holds_get_response_v_2_17 import LegalHoldsGetResponse
from pypureclient.flashblade._common.models.legal_holds_held_entities_get_response_v_2_17 import LegalHoldsHeldEntitiesGetResponse
from pypureclient.flashblade._common.models.legal_holds_held_entities_response_v_2_17 import LegalHoldsHeldEntitiesResponse
from pypureclient.flashblade._common.models.legal_holds_response_v_2_17 import LegalHoldsResponse
...
class LegalHoldsApi:
    ...
    def legal_holds_delete_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api217_legal_holds_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/legal-holds', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def legal_holds_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_legal_holds_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/legal-holds', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def legal_holds_held_entities_get_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_legal_holds_held_entities_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/legal-holds/held-entities', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def legal_holds_held_entities_patch_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_legal_holds_held_entities_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/legal-holds/held-entities', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def legal_holds_held_entities_post_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        file_system_ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of file system IDs. If after filtering, there is not at least one resource that matches each of the elements of `file_system_ids`, then an error is returned. This cannot be provided together with the `file_system_names` query parameter.")] = None,
        file_system_names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of file system names. If there is not at least one resource that matches each of the elements of `file_system_names`, then an error is returned.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_legal_holds_held_entities_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/legal-holds/held-entities', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def legal_holds_patch_with_http_info(
        self,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        ids: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource IDs. If after filtering, there is not at least one resource that matches each of the elements of `ids`, then an error is returned. This cannot be provided together with the `name` or `names` query parameters.")] = None,
        names: Annotated[Optional[conlist(StrictStr)], Field(description="A comma-separated list of resource names. If there is not at least one resource that matches each of the elements of `names`, then an error is returned.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_legal_holds_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/legal-holds', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def legal_holds_post_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_legal_holds_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            f'/api/{self.version}/legal-holds', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    # Method Aliases
    api217_legal_holds_delete_with_http_info = legal_holds_delete_with_http_info
    api217_legal_holds_get_with_http_info = legal_holds_get_with_http_info
    api217_legal_holds_held_entities_get_with_http_info = legal_holds_held_entities_get_with_http_info
    api217_legal_holds_held_entities_patch_with_http_info = legal_holds_held_entities_patch_with_http_info
    api217_legal_holds_held_entities_post_with_http_info = legal_holds_held_entities_post_with_http_info
    api217_legal_holds_patch_with_http_info = legal_holds_patch_with_http_info
    api217_legal_holds_post_with_http_info = legal_holds_post_with_http_info
    api218_legal_holds_delete_with_http_info = legal_holds_delete_with_http_info
    api218_legal_holds_get_with_http_info = legal_holds_get_with_http_info
    api218_legal_holds_held_entities_get_with_http_info = legal_holds_held_entities_get_with_http_info
    api218_legal_holds_held_entities_patch_with_http_info = legal_holds_held_entities_patch_with_http_info
    api218_legal_holds_held_entities_post_with_http_info = legal_holds_held_entities_post_with_http_info
    api218_legal_holds_patch_with_http_info = legal_holds_patch_with_http_info
    api218_legal_holds_post_with_http_info = legal_holds_post_with_http_info
    api219_legal_holds_delete_with_http_info = legal_holds_delete_with_http_info
    api219_legal_holds_get_with_http_info = legal_holds_get_with_http_info
    api219_legal_holds_held_entities_get_with_http_info = legal_holds_held_entities_get_with_http_info
    api219_legal_holds_held_entities_patch_with_http_info = legal_holds_held_entities_patch_with_http_info
    api219_legal_holds_held_entities_post_with_http_info = legal_holds_held_entities_post_with_http_info
    api219_legal_holds_patch_with_http_info = legal_holds_patch_with_http_info
    api219_legal_holds_post_with_http_info = legal_holds_post_with_http_info
    api220_legal_holds_delete_with_http_info = legal_holds_delete_with_http_info
    api220_legal_holds_get_with_http_info = legal_holds_get_with_http_info
    api220_legal_holds_held_entities_get_with_http_info = legal_holds_held_entities_get_with_http_info
    api220_legal_holds_held_entities_patch_with_http_info = legal_holds_held_entities_patch_with_http_info
    api220_legal_holds_held_entities_post_with_http_info = legal_holds_held_entities_post_with_http_info
    api220_legal_holds_patch_with_http_info = legal_holds_patch_with_http_info
    api220_legal_holds_post_with_http_info = legal_holds_post_with_http_info
    api221_legal_holds_delete_with_http_info = legal_holds_delete_with_http_info
    api221_legal_holds_get_with_http_info = legal_holds_get_with_http_info
    api221_legal_holds_held_entities_get_with_http_info = legal_holds_held_entities_get_with_http_info
    api221_legal_holds_held_entities_patch_with_http_info = legal_holds_held_entities_patch_with_http_info
    api221_legal_holds_held_entities_post_with_http_info = legal_holds_held_entities_post_with_http_info
    api221_legal_holds_patch_with_http_info = legal_holds_patch_with_http_info
    api221_legal_holds_post_with_http_info = legal_holds_post_with_http_info
    api222_legal_holds_delete_with_http_info = legal_holds_delete_with_http_info
    api222_legal_holds_get_with_http_info = legal_holds_get_with_http_info
    api222_legal_holds_held_entities_get_with_http_info = legal_holds_held_entities_get_with_http_info
    api222_legal_holds_held_entities_patch_with_http_info = legal_holds_held_entities_patch_with_http_info
    api222_legal_holds_held_entities_post_with_http_info = legal_holds_held_entities_post_with_http_info
    api222_legal_holds_patch_with_http_info = legal_holds_patch_with_http_info
    api222_legal_holds_post_with_http_info = legal_holds_post_with_http_info
    api223_legal_holds_delete_with_http_info = legal_holds_delete_with_http_info
    api223_legal_holds_get_with_http_info = legal_holds_get_with_http_info
    api223_legal_holds_held_entities_get_with_http_info = legal_holds_held_entities_get_with_http_info
    api223_legal_holds_held_entities_patch_with_http_info = legal_holds_held_entities_patch_with_http_info
    api223_legal_holds_held_entities_post_with_http_info = legal_holds_held_entities_post_with_http_info
    api223_legal_holds_patch_with_http_info = legal_holds_patch_with_http_info
    api223_legal_holds_post_with_http_info = legal_holds_post_with_http_info
    api224_legal_holds_delete_with_http_info = legal_holds_delete_with_http_info
    api224_legal_holds_get_with_http_info = legal_holds_get_with_http_info
    api224_legal_holds_held_entities_get_with_http_info = legal_holds_held_entities_get_with_http_info
    api224_legal_holds_held_entities_patch_with_http_info = legal_holds_held_entities_patch_with_http_info
    api224_legal_holds_held_entities_post_with_http_info = legal_holds_held_entities_post_with_http_info
    api224_legal_holds_patch_with_http_info = legal_holds_patch_with_http_info
    api224_legal_holds_post_with_http_info = legal_holds_post_with_http_info
    api225_legal_holds_delete_with_http_info = legal_holds_delete_with_http_info
    api225_legal_holds_get_with_http_info = legal_holds_get_with_http_info
    api225_legal_holds_held_entities_get_with_http_info = legal_holds_held_entities_get_with_http_info
    api225_legal_holds_held_entities_patch_with_http_info = legal_holds_held_entities_patch_with_http_info
