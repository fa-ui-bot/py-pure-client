...
class LinkAggregationGroupsApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api214_link_aggregation_groups_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_link_aggregation_groups_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_link_aggregation_groups_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api214_link_aggregation_groups_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api214_link_aggregation_groups_delete_with_http_info = link_aggregation_groups_delete_with_http_info
    api214_link_aggregation_groups_get_with_http_info = link_aggregation_groups_get_with_http_info
    api214_link_aggregation_groups_patch_with_http_info = link_aggregation_groups_patch_with_http_info
    api214_link_aggregation_groups_post_with_http_info = link_aggregation_groups_post_with_http_info
    api215_link_aggregation_groups_delete_with_http_info = link_aggregation_groups_delete_with_http_info
    api215_link_aggregation_groups_get_with_http_info = link_aggregation_groups_get_with_http_info
    api215_link_aggregation_groups_patch_with_http_info = link_aggregation_groups_patch_with_http_info
    api215_link_aggregation_groups_post_with_http_info = link_aggregation_groups_post_with_http_info
    api216_link_aggregation_groups_delete_with_http_info = link_aggregation_groups_delete_with_http_info
    api216_link_aggregation_groups_get_with_http_info = link_aggregation_groups_get_with_http_info
    api216_link_aggregation_groups_patch_with_http_info = link_aggregation_groups_patch_with_http_info
    api216_link_aggregation_groups_post_with_http_info = link_aggregation_groups_post_with_http_info
