...
from pypureclient.flashblade._common.models.storage_class_tiering_policies_get_response_v_2_25 import StorageClassTieringPoliciesGetResponse
...
from pypureclient.flashblade._common.models.storage_class_tiering_policies_response_v_2_25 import StorageClassTieringPoliciesResponse
from pypureclient.flashblade._common.models.storage_class_tiering_policy_v_2_25 import StorageClassTieringPolicy
...
class PoliciesStorageClassTieringApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_storage_class_tiering_policies_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_storage_class_tiering_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_storage_class_tiering_policies_members_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_storage_class_tiering_policies_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_storage_class_tiering_policies_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api227_storage_class_tiering_policies_delete_with_http_info = storage_class_tiering_policies_delete_with_http_info
    api227_storage_class_tiering_policies_get_with_http_info = storage_class_tiering_policies_get_with_http_info
    api227_storage_class_tiering_policies_members_get_with_http_info = storage_class_tiering_policies_members_get_with_http_info
    api227_storage_class_tiering_policies_patch_with_http_info = storage_class_tiering_policies_patch_with_http_info
    api227_storage_class_tiering_policies_post_with_http_info = storage_class_tiering_policies_post_with_http_info
    api228_storage_class_tiering_policies_delete_with_http_info = storage_class_tiering_policies_delete_with_http_info
    api228_storage_class_tiering_policies_get_with_http_info = storage_class_tiering_policies_get_with_http_info
    api228_storage_class_tiering_policies_members_get_with_http_info = storage_class_tiering_policies_members_get_with_http_info
    api228_storage_class_tiering_policies_patch_with_http_info = storage_class_tiering_policies_patch_with_http_info
    api228_storage_class_tiering_policies_post_with_http_info = storage_class_tiering_policies_post_with_http_info
