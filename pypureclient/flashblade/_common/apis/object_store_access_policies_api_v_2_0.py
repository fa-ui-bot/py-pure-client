...
from pypureclient.flashblade._common.models.object_store_access_policies_get_response_v_2_0 import ObjectStoreAccessPoliciesGetResponse
...
class ObjectStoreAccessPoliciesApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api20_object_store_access_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_object_store_access_policies_object_store_users_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_object_store_access_policies_object_store_users_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api20_object_store_access_policies_object_store_users_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api20_object_store_access_policies_get_with_http_info = object_store_access_policies_get_with_http_info
    api20_object_store_access_policies_object_store_users_delete_with_http_info = object_store_access_policies_object_store_users_delete_with_http_info
    api20_object_store_access_policies_object_store_users_get_with_http_info = object_store_access_policies_object_store_users_get_with_http_info
    api20_object_store_access_policies_object_store_users_post_with_http_info = object_store_access_policies_object_store_users_post_with_http_info
    api21_object_store_access_policies_get_with_http_info = object_store_access_policies_get_with_http_info
    api21_object_store_access_policies_object_store_users_delete_with_http_info = object_store_access_policies_object_store_users_delete_with_http_info
    api21_object_store_access_policies_object_store_users_get_with_http_info = object_store_access_policies_object_store_users_get_with_http_info
    api21_object_store_access_policies_object_store_users_post_with_http_info = object_store_access_policies_object_store_users_post_with_http_info
