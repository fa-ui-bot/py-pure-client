...
class VerificationKeysApi:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api217_support_verification_keys_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api217_support_verification_keys_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    # Method Aliases
    api217_support_verification_keys_get_with_http_info = support_verification_keys_get_with_http_info
    api217_support_verification_keys_patch_with_http_info = support_verification_keys_patch_with_http_info
    api218_support_verification_keys_get_with_http_info = support_verification_keys_get_with_http_info
    api218_support_verification_keys_patch_with_http_info = support_verification_keys_patch_with_http_info
    api219_support_verification_keys_get_with_http_info = support_verification_keys_get_with_http_info
    api219_support_verification_keys_patch_with_http_info = support_verification_keys_patch_with_http_info
    api220_support_verification_keys_get_with_http_info = support_verification_keys_get_with_http_info
    api220_support_verification_keys_patch_with_http_info = support_verification_keys_patch_with_http_info
    api221_support_verification_keys_get_with_http_info = support_verification_keys_get_with_http_info
    api221_support_verification_keys_patch_with_http_info = support_verification_keys_patch_with_http_info
    api222_support_verification_keys_get_with_http_info = support_verification_keys_get_with_http_info
    api222_support_verification_keys_patch_with_http_info = support_verification_keys_patch_with_http_info
    api223_support_verification_keys_get_with_http_info = support_verification_keys_get_with_http_info
    api223_support_verification_keys_patch_with_http_info = support_verification_keys_patch_with_http_info
    api224_support_verification_keys_get_with_http_info = support_verification_keys_get_with_http_info
