...
from pypureclient.flashblade._common.models.snmp_manager_get_response_v_2_22 import SnmpManagerGetResponse
from pypureclient.flashblade._common.models.snmp_manager_post_v_2_0 import SnmpManagerPost
from pypureclient.flashblade._common.models.snmp_manager_response_v_2_22 import SnmpManagerResponse
from pypureclient.flashblade._common.models.snmp_manager_v_2_22 import SnmpManager
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api227_snmp_managers_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_snmp_managers_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_snmp_managers_patch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_snmp_managers_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api227_snmp_managers_test_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
