...
class KMIPApi:
    ...
    api218_kmip_delete_with_http_info = kmip_delete_with_http_info
    api218_kmip_get_with_http_info = kmip_get_with_http_info
    api218_kmip_patch_with_http_info = kmip_patch_with_http_info
    api218_kmip_post_with_http_info = kmip_post_with_http_info
    api218_kmip_test_get_with_http_info = kmip_test_get_with_http_info
