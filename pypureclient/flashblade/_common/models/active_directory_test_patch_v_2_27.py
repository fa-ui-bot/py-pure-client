...
class ActiveDirectoryTestPatch(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActiveDirectoryTestPatch:
        """Create an instance of ActiveDirectoryTestPatch from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ActiveDirectoryTestPatch:
        """Create an instance of ActiveDirectoryTestPatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActiveDirectoryTestPatch.parse_obj(obj)

        _obj = ActiveDirectoryTestPatch.construct(_fields_set=None, **{
