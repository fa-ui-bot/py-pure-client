...
class Array(BaseModel):
    ...
    smb_mode: Optional[StrictStr] = Field(default=None, description="The current SMB mode of the array. This controls the type of authentication that is used by the array for SMB. Possible values include `ad-auto`, `ad-rfc2307`, `guest`, and `native`. Modifying this value requires the assistance of Everpure Support.")
