...
class ManagementAccessPolicyRule(BaseModel):
    """
    ...
    role: Optional[ReferenceWritable] = Field(default=None, description="Role defines a set of permissions applicable in a scope. `viewer` grants users the ability to read within a scope. `support` grants the ability to perform general support-related actions as well as read within a scope. `storage` grants access to all storage operations within a scope. `admin` grants access to all operations.")
    ...
    __properties = ["context", "id", "name", "role", "scope", "index", "policy", "policy_version"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ManagementAccessPolicyRule:
        """Create an instance of ManagementAccessPolicyRule from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ManagementAccessPolicyRule:
        """Create an instance of ManagementAccessPolicyRule from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ManagementAccessPolicyRule.parse_obj(obj)

        _obj = ManagementAccessPolicyRule.construct(_fields_set=None, **{
