...
class FileSystem(BaseModel):
    ...
    realms: Optional[conlist(FixedReference)] = Field(default=None, description="The realms containing this file system.")
    ...
    __properties = ["id", "name", "context", "created", "default_group_quota", "default_user_quota", "destroyed", "eradication_config", "fast_remove_directory_enabled", "group_ownership", "hard_limit_enabled", "http", "multi_protocol", "nfs", "node_group", "promotion_status", "provisioned", "qos_policy", "realms", "requested_promotion_state", "smb", "snapshot_directory_enabled", "source", "space", "storage_class", "time_remaining", "workload", "writable"]
