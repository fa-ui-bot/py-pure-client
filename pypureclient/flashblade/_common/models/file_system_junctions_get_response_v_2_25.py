...
class FileSystemJunctionsGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(FileSystemJunction)] = Field(default=None, description="A list of file system junction objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FileSystemJunctionsGetResponse:
        """Create an instance of FileSystemJunctionsGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> FileSystemJunctionsGetResponse:
        """Create an instance of FileSystemJunctionsGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FileSystemJunctionsGetResponse.parse_obj(obj)

        _obj = FileSystemJunctionsGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [FileSystemJunction.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
