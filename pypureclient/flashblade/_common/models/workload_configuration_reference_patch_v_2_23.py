...
class WorkloadConfigurationReferencePatch(BaseModel):
    """
    Set the `id` or `name` of the workload to an empty string to remove the resource from the workload.
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkloadConfigurationReferencePatch:
        """Create an instance of WorkloadConfigurationReferencePatch from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> WorkloadConfigurationReferencePatch:
        """Create an instance of WorkloadConfigurationReferencePatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkloadConfigurationReferencePatch.parse_obj(obj)

        _obj = WorkloadConfigurationReferencePatch.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
