...
from pypureclient.flashblade._common.models.management_access_policy_role_permission_supported_resource_v_2_26 import ManagementAccessPolicyRolePermissionSupportedResource


class ManagementAccessPolicyRolePermissionSupportedResourcesGetResponse(BaseModel):
    """
    ...
    items: Optional[conlist(ManagementAccessPolicyRolePermissionSupportedResource)] = Field(default=None, description="Displays a list of all items after filtering. If applicable, the values are displayed for each name.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ManagementAccessPolicyRolePermissionSupportedResourcesGetResponse:
        """Create an instance of ManagementAccessPolicyRolePermissionSupportedResourcesGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ManagementAccessPolicyRolePermissionSupportedResourcesGetResponse:
        """Create an instance of ManagementAccessPolicyRolePermissionSupportedResourcesGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ManagementAccessPolicyRolePermissionSupportedResourcesGetResponse.parse_obj(obj)

        _obj = ManagementAccessPolicyRolePermissionSupportedResourcesGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [ManagementAccessPolicyRolePermissionSupportedResource.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
