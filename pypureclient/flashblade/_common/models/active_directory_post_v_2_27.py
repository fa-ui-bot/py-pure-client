...
class ActiveDirectoryPost(BaseModel):
    ...
    __properties = ["directory_servers", "global_catalog_servers", "kerberos_servers", "ca_certificate", "ca_certificate_group", "computer_name", "domain", "encryption_types", "fqdns", "join_ou", "password", "service_principal_names", "user"]
