...
class FileSystem(BaseModel):
    ...
    __properties = ["id", "name", "created", "default_group_quota", "default_user_quota", "destroyed", "eradication_config", "fast_remove_directory_enabled", "group_ownership", "hard_limit_enabled", "http", "multi_protocol", "nfs", "promotion_status", "provisioned", "requested_promotion_state", "smb", "snapshot_directory_enabled", "source", "space", "storage_class", "time_remaining", "writable"]
