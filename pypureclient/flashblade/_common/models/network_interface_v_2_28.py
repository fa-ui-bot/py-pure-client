...
class NetworkInterface(BaseModel):
    ...
    attached_servers: Optional[conlist(Reference)] = Field(default=None, description="List of servers that are using this interface for data ingress.")
    enabled: Optional[StrictBool] = Field(default=None, description="Indicates if the specified network interface is enabled (`true`) or disabled (`false`).")
    ...
    rdma_enabled: Optional[StrictBool] = Field(default=None, description="If (`true`) indicated that RDMA is enabled on the network interface. If (`false`), RDMA is disabled on the network interface.")
    ...
    __properties = ["id", "name", "realms", "address", "attached_servers", "enabled", "gateway", "mtu", "netmask", "rdma_enabled", "services", "subnet", "type", "vlan"]
    ...
    def from_dict(cls, obj: dict) -> NetworkInterface:
        ...
        _obj = NetworkInterface.construct(_fields_set=None, **{
            ...
            "rdma_enabled": obj.get("rdma_enabled"),
