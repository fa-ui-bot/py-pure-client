...
from pypureclient.flashblade._common.models.support_system_manifest_v_2_26 import SupportSystemManifest


class SupportSystemManifestResponse(BaseModel):
    """
    ...
    items: Optional[conlist(SupportSystemManifest)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SupportSystemManifestResponse:
        """Create an instance of SupportSystemManifestResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> SupportSystemManifestResponse:
        """Create an instance of SupportSystemManifestResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SupportSystemManifestResponse.parse_obj(obj)

        _obj = SupportSystemManifestResponse.construct(_fields_set=None, **{
            ...
            "items": [SupportSystemManifest.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
