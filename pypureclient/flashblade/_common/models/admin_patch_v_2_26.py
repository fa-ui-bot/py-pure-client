...
class AdminPatch(BaseModel):
    ...
    management_access_policies: Optional[conlist(ReferenceWritable)] = Field(default=None, description="List of management access policies associated with the statically-authorized administrator. It's only used when converting remote users from dynamically- to be statically-authorized.")
    ...
    __properties = ["authorization_model", "locked", "management_access_policies", "old_password", "password", "public_key", "role"]
