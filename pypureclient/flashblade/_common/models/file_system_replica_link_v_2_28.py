...
class FileSystemReplicaLink(BaseModel):
    ...
    remote: Optional[FixedReference] = Field(default=None, description="Reference to a remote array or realm.")
    ...
    status: Optional[StrictStr] = Field(default=None, description="Status of the replica link. Values include `replicating`, `idle`, `quiescing`, `quiesced` and `unhealthy`.")
