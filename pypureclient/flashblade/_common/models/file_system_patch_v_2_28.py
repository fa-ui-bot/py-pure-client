...
class FileSystemPatch(BaseModel):
    ...
    abort_quiesce: Optional[StrictBool] = Field(default=None, description="This parameter must be set to `true` while trying to abort a planned failover and force promote a file system. This will cancel any on-going data transfer and the file system will transition to `promoted` state.")
    ...
    quiesce: Optional[StrictBool] = Field(default=None, description="This parameter must be set to `true` while trying to trigger a planned failover operation. Upon execution of the operation, the source file system will be in a `demoting` state until all the data is replicated to the target file system. Once the data replication is complete, the source file system will transition to `demoted` state.")
    ...
    skip_quiesce: Optional[StrictBool] = Field(default=None, description="This parameter must be set to `true` while trying to skip a planned failover and force demote a file system. This will cancel any on-going data transfer and the file system will transition to `demoted` state.")
    ...
    __properties = ["id", "name", "abort_quiesce", "created", "default_group_quota", "default_user_quota", "destroyed", "fast_remove_directory_enabled", "group_ownership", "hard_limit_enabled", "http", "multi_protocol", "nfs", "promotion_status", "provisioned", "qos_policy", "quiesce", "requested_promotion_state", "skip_quiesce", "smb", "snapshot_directory_enabled", "source", "storage_class", "time_remaining", "workload", "writable"]
    ...
    def from_dict(cls, obj: dict) -> FileSystemPatch:
        ...
        _obj = FileSystemPatch.construct(_fields_set=None, **{
            "id": obj.get("id"),
            "name": obj.get("name"),
            "abort_quiesce": obj.get("abort_quiesce"),
            ...
            "skip_quiesce": obj.get("skip_quiesce"),
