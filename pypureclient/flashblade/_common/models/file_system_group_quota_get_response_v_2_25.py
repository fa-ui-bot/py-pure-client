...
class FileSystemGroupQuotaGetResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FileSystemGroupQuotaGetResponse:
        """Create an instance of FileSystemGroupQuotaGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> FileSystemGroupQuotaGetResponse:
        """Create an instance of FileSystemGroupQuotaGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FileSystemGroupQuotaGetResponse.parse_obj(obj)

        _obj = FileSystemGroupQuotaGetResponse.construct(_fields_set=None, **{
