...
class ManagementAccessPolicyRolesGetResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ManagementAccessPolicyRolesGetResponse:
        """Create an instance of ManagementAccessPolicyRolesGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ManagementAccessPolicyRolesGetResponse:
        """Create an instance of ManagementAccessPolicyRolesGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ManagementAccessPolicyRolesGetResponse.parse_obj(obj)

        _obj = ManagementAccessPolicyRolesGetResponse.construct(_fields_set=None, **{
