...
class Bucket(BaseModel):
    ...
    time_remaining: Optional[StrictInt] = Field(default=None, description="Time in milliseconds before the bucket is eradicated. `null` if not destroyed or remaning time until eradication is not known yet.")
