...
class DataEvictionPolicy(BaseModel):
    """
    DataEvictionPolicy
    """
    ...
    keep_size: Optional[StrictInt] = Field(default=None, description="The maximum physical data space(in bytes) of a target file system to have no non-expired data evicted.")
    __properties = ["context", "id", "name", "realms", "enabled", "is_local", "location", "policy_type", "keep_size"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataEvictionPolicy:
        """Create an instance of DataEvictionPolicy from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> DataEvictionPolicy:
        """Create an instance of DataEvictionPolicy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DataEvictionPolicy.parse_obj(obj)

        _obj = DataEvictionPolicy.construct(_fields_set=None, **{
