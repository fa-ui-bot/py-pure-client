...
class Array(BaseModel):
    ...
    __properties = ["id", "name", "_as_of", "banner", "default_inbound_tls_policy", "encryption", "eradication_config", "idle_timeout", "network_access_policy", "ntp_servers", "os", "product_type", "revision", "security_update", "smb_mode", "time_zone", "version"]
