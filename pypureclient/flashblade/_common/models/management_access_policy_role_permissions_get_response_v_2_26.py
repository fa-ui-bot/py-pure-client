...
class ManagementAccessPolicyRolePermissionsGetResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ManagementAccessPolicyRolePermissionsGetResponse:
        """Create an instance of ManagementAccessPolicyRolePermissionsGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> ManagementAccessPolicyRolePermissionsGetResponse:
        """Create an instance of ManagementAccessPolicyRolePermissionsGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ManagementAccessPolicyRolePermissionsGetResponse.parse_obj(obj)

        _obj = ManagementAccessPolicyRolePermissionsGetResponse.construct(_fields_set=None, **{
