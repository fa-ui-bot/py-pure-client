...
class CertificateBase(BaseModel):
    ...
    __properties = ["realms", "certificate", "certificate_type", "common_name", "country", "email", "intermediate_certificate", "issued_by", "issued_to", "key_algorithm", "key_size", "locality", "organization", "organizational_unit", "state", "status", "subject_alternative_names", "valid_from", "valid_to"]
