...
class Admin(BaseModel):
    ...
    admin_type: Optional[StrictStr] = Field(default=None, description="The type of admin account. Valid values include `local-user` and `remote-user`. A `local-user` is managed directly on the array. A `remote-user` is provisioned by an external system such as LDAP or SAML.")
    api_token: Optional[ApiToken] = None
    authorization_model: Optional[StrictStr] = Field(default=None, description="The location for access policies mapping. Returns `static` if they're configured locally on the array. Otherwise, `dynamic` is returned, indicating they're decided by an external system e.g. LDAP, IDP. ")
    ...
    __properties = ["id", "name", "context", "admin_type", "api_token", "authorization_model", "is_local", "locked", "lockout_remaining", "management_access_policies", "public_key", "role"]
