...
from pypureclient.flashblade._common.models.tgroup_v_2_26 import Tgroup


class TgroupGetResponse(BaseModel):
    """
    TgroupGetResponse
    """
    ...
    items: Optional[conlist(Tgroup)] = Field(default=None, description="Displays a list of topology groups after the operation.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TgroupGetResponse:
        """Create an instance of TgroupGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> TgroupGetResponse:
        """Create an instance of TgroupGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TgroupGetResponse.parse_obj(obj)

        _obj = TgroupGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [Tgroup.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
