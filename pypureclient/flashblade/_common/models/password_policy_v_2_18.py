...
class PasswordPolicy(BaseModel):
    ...
    __properties = ["id", "name", "enabled", "is_local", "location", "policy_type", "enforce_dictionary_check", "enforce_username_check", "lockout_duration", "max_login_attempts", "max_password_age", "min_character_groups", "min_characters_per_group", "min_password_age", "min_password_length", "password_history"]
