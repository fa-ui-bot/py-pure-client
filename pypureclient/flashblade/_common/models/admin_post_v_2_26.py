...
class AdminPost(BaseModel):
    ...
    """
    admin_type: Optional[StrictStr] = Field(default=None, description="The type of admin account. Set to `service-account` to create a REST-only service account. Service accounts do not have passwords and cannot have associated public keys. If not specified, defaults to `local-user`.")
    ...
    __properties = ["admin_type", "management_access_policies", "password", "public_key", "role"]
