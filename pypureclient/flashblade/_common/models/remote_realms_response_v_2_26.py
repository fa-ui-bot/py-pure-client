...
from pypureclient.flashblade._common.models.remote_realm1_v_2_28 import RemoteRealm1
...
class RemoteRealmsResponse(BaseModel):
    ...
    items: Optional[conlist(RemoteRealm1)] = Field(default=None, description="Returns a list of all items after filtering. The values are displayed for each name where meaningful.")
    ...
    def from_dict(cls, obj: dict) -> RemoteRealmsResponse:
        ...
        _obj = RemoteRealmsResponse.construct(_fields_set=None, **{
            ...
            "items": [RemoteRealm1.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
