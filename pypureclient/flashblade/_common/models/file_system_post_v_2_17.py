...
class FileSystemPost(BaseModel):
    ...
    __properties = ["default_group_quota", "default_user_quota", "eradication_config", "fast_remove_directory_enabled", "group_ownership", "hard_limit_enabled", "http", "multi_protocol", "nfs", "provisioned", "qos_policy", "requested_promotion_state", "smb", "snapshot_directory_enabled", "source", "writable"]
