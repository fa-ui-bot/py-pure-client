...
from pypureclient.pure1.Pure1_1_5.models.cve import Cve


class CveGetResponse(BaseModel):
    """
    CveGetResponse
    """
    ...
    items: Optional[conlist(Cve)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CveGetResponse:
        """Create an instance of CveGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> CveGetResponse:
        """Create an instance of CveGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CveGetResponse.parse_obj(obj)

        _obj = CveGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [Cve.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
