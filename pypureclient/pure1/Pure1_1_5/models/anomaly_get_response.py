...
from pypureclient.pure1.Pure1_1_5.models.anomaly import Anomaly


class AnomalyGetResponse(BaseModel):
    """
    AnomalyGetResponse
    """
    ...
    items: Optional[conlist(Anomaly)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AnomalyGetResponse:
        """Create an instance of AnomalyGetResponse from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AnomalyGetResponse:
        """Create an instance of AnomalyGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AnomalyGetResponse.parse_obj(obj)

        _obj = AnomalyGetResponse.construct(_fields_set=None, **{
            "continuation_token": obj.get("continuation_token"),
            "total_item_count": obj.get("total_item_count"),
            "items": [Anomaly.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
