...
from pypureclient.pure1.Pure1_1_5.models.hardware_connector_get_response import HardwareConnectorGetResponse
from typing import Optional
...
class HardwareConnectorsApi:
    ...
    def api15_hardware_connectors_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api15_hardware_connectors_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/1.5/hardware-connectors', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
