...
from pypureclient.pure1.Pure1_1_5.models.alerts_get_response import AlertsGetResponse
from typing import Optional
...
class AlertsApi:
    ...
    def api15_alerts_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api15_alerts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
