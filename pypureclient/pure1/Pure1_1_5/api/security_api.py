...
from pypureclient.pure1.Pure1_1_5.models.anomaly_get_response import AnomalyGetResponse
from pypureclient.pure1.Pure1_1_5.models.cve_get_response import CveGetResponse
from pypureclient.pure1.Pure1_1_5.models.security_insight_array_get_response import SecurityInsightArrayGetResponse
from typing import Optional
...
class SecurityApi:
    ...
    def api15_assessment_security_anomalies_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        :rtype: tuple(AnomalyGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api15_assessment_security_anomalies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/1.5/assessment/security/anomalies', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api15_assessment_security_cves_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result. Single quotes are required around all strings.")] = None,
        ...
        **kwargs
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CveGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api15_assessment_security_cves_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/1.5/assessment/security/cves', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api15_assessment_security_insights_arrays_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result. Single quotes are required around all strings.")] = None,
        ...
        **kwargs
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(SecurityInsightArrayGetResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api15_assessment_security_insights_arrays_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "SecurityInsightArrayGetResponse",
            '400': "Error",
            '403': "ErrorNoContext",
            '404': "Error",
            '429': "ErrorNoContext",
        ...
        return self.api_client.call_api(
            '/api/1.5/assessment/security/insights/arrays', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
