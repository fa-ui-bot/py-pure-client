...
class Client(object):
    ...
    def get_protection_group_snapshots(
        ...
        _process_references(sources, ['source_ids', 'source_names'], kwargs)
        _fixup_list_type_params(['ids', 'names', 'sort', 'source_ids', 'source_names'], kwargs)
        return self._call_api('ProtectionGroupSnapshotsApi', 'api15_protection_group_snapshots_get_with_http_info', kwargs)
    ...
    def get_protection_group_snapshots_transfer(
        ...
        _process_references(sources, ['source_ids', 'source_names'], kwargs)
        _fixup_list_type_params(['ids', 'names', 'sort', 'source_ids', 'source_names'], kwargs)
        return self._call_api('ProtectionGroupSnapshotsApi', 'api15_protection_group_snapshots_transfer_get_with_http_info', kwargs)

    def get_assessment_security_anomalies(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result. Single quotes are required around all strings.")] = None,
        ...
        return self._call_api('SecurityApi', 'api15_assessment_security_anomalies_get_with_http_info', kwargs)

    def get_assessment_security_cves(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result. Single quotes are required around all strings.")] = None,
        ...
        """Get common vulnerabilities and exposures
        
        Retrieves common vulnerabilities and exposures (CVEs) and their details, including description, severity, affected and fixed versions, affected appliances, and link to additional information. Results can be filtered by `id`, `severity`, and `cvss_score`, and sorted by any of those fields.
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None or k in [Parameters.x_request_id, Parameters.limit]}
        _fixup_list_type_params(['sort'], kwargs)
        return self._call_api('SecurityApi', 'api15_assessment_security_cves_get_with_http_info', kwargs)

    def get_assessment_security_insights_arrays(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result. Single quotes are required around all strings.")] = None,
        ...
        """Get appliance security insights information.
        ...
        kwargs = {k: v for k, v in kwargs.items() if v is not None or k in [Parameters.x_request_id, Parameters.limit]}
        _fixup_list_type_params(['sort'], kwargs)
        return self._call_api('SecurityApi', 'api15_assessment_security_insights_arrays_get_with_http_info', kwargs)
