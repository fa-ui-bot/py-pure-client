...
class AssetSpaceTotalUsedRatio(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AssetSpaceTotalUsedRatio:
        """Create an instance of AssetSpaceTotalUsedRatio from a JSON string"""
        return cls.from_dict(json.loads(json_str))

    @classmethod
    def from_dict(cls, obj: dict) -> AssetSpaceTotalUsedRatio:
        """Create an instance of AssetSpaceTotalUsedRatio from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AssetSpaceTotalUsedRatio.parse_obj(obj)

        _obj = AssetSpaceTotalUsedRatio.construct(_fields_set=None, **{
            "data": obj.get("data"),
