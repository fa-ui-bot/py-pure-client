...
from pypureclient.pure1.Pure1_1_3.models.base_address import BaseAddress
...
from pypureclient.pure1.Pure1_1_3.models.license_resource_reference import LicenseResourceReference
from pypureclient.pure1.Pure1_1_3.models.marketplace_partner import MarketplacePartner
from pypureclient.pure1.Pure1_1_3.models.subscription_license_pre_ratio import SubscriptionLicensePreRatio
...
class SubscriptionLicense(BaseModel):
    ...
    __properties = ["_as_of", "id", "name", "average_on_demand", "expiration_date", "last_updated_date", "marketplace_partner", "pre_ratio", "quarter_on_demand", "reservation", "resources", "service_tier", "site_address", "start_date", "subscription", "usage"]
