...
from pypureclient.pure1.Pure1_1_3.models.bucket_replica_link_get_response import BucketReplicaLinkGetResponse
from typing import Optional
...
class BucketReplicaLinksApi:
    ...
    def api13_bucket_replica_links_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api13_bucket_replica_links_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/1.3/bucket-replica-links', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
