...
from pypureclient.pure1.Pure1_1_3.models.controller_get_response import ControllerGetResponse
from typing import Optional
...
class ControllersApi:
    ...
    def api13_controllers_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api13_controllers_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
