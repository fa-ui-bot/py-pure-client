...
from pypureclient.pure1.Pure1_1_3.models.volume_snapshot_get_response import VolumeSnapshotGetResponse
from typing import Optional
...
class VolumeSnapshotsApi:
    ...
    def api13_volume_snapshots_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api13_volume_snapshots_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
