...
from pypureclient.pure1.Pure1_1_3.models.file_system_replica_link_get_response import FileSystemReplicaLinkGetResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api13_file_system_replica_links_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api13_file_system_replica_links_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
