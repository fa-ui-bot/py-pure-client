...
from pypureclient.pure1.Pure1_1_3.models.target_get_response import TargetGetResponse
from typing import Optional
...
class TargetsApi:
    ...
    def api13_targets_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api13_targets_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
