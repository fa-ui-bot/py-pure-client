...
class MetricsApi:
    ...
    def api13_metrics_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api13_metrics_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api13_metrics_history_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api13_metrics_history_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
