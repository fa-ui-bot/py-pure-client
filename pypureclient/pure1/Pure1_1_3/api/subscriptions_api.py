...
from pypureclient.pure1.Pure1_1_3.models.subscription_asset_get_response import SubscriptionAssetGetResponse
from pypureclient.pure1.Pure1_1_3.models.subscription_get_response import SubscriptionGetResponse
from pypureclient.pure1.Pure1_1_3.models.subscription_license_get_response import SubscriptionLicenseGetResponse
from typing import Optional
...
class SubscriptionsApi:
    ...
    def api13_subscription_assets_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api13_subscription_assets_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/1.3/subscription-assets', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api13_subscription_licenses_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result. Single quotes are required around all strings.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api13_subscription_licenses_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/1.3/subscription-licenses', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api13_subscriptions_get_with_http_info(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="Access token (in JWT format) required to use any API endpoint (except `/oauth2`)")] = None,
        x_request_id: Annotated[Optional[StrictStr], Field(description="Supplied by client during request or generated by server.")] = None,
        continuation_token: Annotated[Optional[StrictStr], Field(description="An opaque token used to iterate over a collection. The token to use on the next request is returned in the `continuation_token` field of the result. Single quotes are required around all strings.")] = None,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api13_subscriptions_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
