...
from pypureclient.pure1.Pure1_1_1.models.file_system_snapshot_get_response import FileSystemSnapshotGetResponse
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api11_file_system_snapshots_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api11_file_system_snapshots_policies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
