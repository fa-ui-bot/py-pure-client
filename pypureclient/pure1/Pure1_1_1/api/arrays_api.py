...
from pypureclient.pure1.Pure1_1_1.models.array_get_response import ArrayGetResponse
from pypureclient.pure1.Pure1_1_1.models.support_contract_get_response import SupportContractGetResponse
from pypureclient.pure1.Pure1_1_1.models.tag_get_response import TagGetResponse
from pypureclient.pure1.Pure1_1_1.models.tag_put import TagPut
from pypureclient.pure1.Pure1_1_1.models.tag_response import TagResponse
from typing import Optional
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api11_arrays_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api11_arrays_support_contracts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api11_arrays_tags_batch_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api11_arrays_tags_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api11_arrays_tags_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
