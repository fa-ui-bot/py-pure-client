...
from pypureclient.pure1.Pure1_1_0.models.network_interface_get_response import NetworkInterfaceGetResponse
from typing import Optional
...
class NetworkInterfacesApi:
    ...
    def api10_network_interfaces_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api10_network_interfaces_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
