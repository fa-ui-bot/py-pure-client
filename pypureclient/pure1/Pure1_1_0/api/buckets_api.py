...
from pypureclient.pure1.Pure1_1_0.models.bucket_get_response import BucketGetResponse
from typing import Optional
...
class BucketsApi:
    ...
    def api10_buckets_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api10_buckets_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
