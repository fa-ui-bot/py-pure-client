...
from pypureclient.pure1.Pure1_1_0.models.bucket_replica_link_get_response import BucketReplicaLinkGetResponse
from typing import Optional
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api10_bucket_replica_links_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
