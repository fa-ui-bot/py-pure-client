...
class ObjectStoreAccount(BaseModel):
    ...
    created: Optional[StrictInt] = Field(default=None, description="Creation timestamp of the object, in milliseconds since Unix epoch.")
    object_count: Optional[StrictInt] = Field(default=None, description="The number of objects within the account.")
    __properties = ["_as_of", "id", "name", "arrays", "created", "object_count"]
