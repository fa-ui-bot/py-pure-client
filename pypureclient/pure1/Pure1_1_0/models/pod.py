...
from pypureclient.pure1.Pure1_1_0.models.pod_array_status import PodArrayStatus
...
class Pod(BaseModel):
    ...
    arrays: Optional[conlist(PodArrayStatus, min_items=1)] = Field(default=None, description="A list of arrays that share this pod. If two or more arrays are specified, all data in the pod is synchronously mirrored between them.")
