...
class ResourceWithLocations(BaseModel):
    ...
    locations: Optional[conlist(FixedReference)] = None
    ...
    def from_dict(cls, obj: dict) -> ResourceWithLocations:
        ...
        _obj = ResourceWithLocations.construct(_fields_set=None, **{
            ...
            "locations": [FixedReference.from_dict(_item) for _item in obj.get("locations")] if obj.get("locations") is not None else None
        })
        return _obj
