...
class SubscriptionAsset(BaseModel):
    ...
    __properties = ["_as_of", "id", "name", "activation_date", "array", "end_of_life_date", "install_address", "license", "subscription"]
    ...
    def from_dict(cls, obj: dict) -> SubscriptionAsset:
        ...
        _obj = SubscriptionAsset.construct(_fields_set=None, **{
            ...
            "install_address": BaseAddress.from_dict(obj.get("install_address")) if obj.get("install_address") is not None else None,
