...
from pypureclient.pure1.Pure1_1_2.models.audits_get_response import AuditsGetResponse
from typing import Optional
...
class AuditsApi:
    ...
    def api12_audits_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api12_audits_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
