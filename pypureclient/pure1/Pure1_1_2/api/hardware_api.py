...
from pypureclient.pure1.Pure1_1_2.models.hardware_get_response import HardwareGetResponse
from typing import Optional
...
class HardwareApi:
    ...
    def api12_hardware_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api12_hardware_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
