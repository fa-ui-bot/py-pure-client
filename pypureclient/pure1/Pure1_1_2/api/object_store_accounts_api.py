...
from pypureclient.pure1.Pure1_1_2.models.object_store_account_get_response import ObjectStoreAccountGetResponse
from typing import Optional
...
class ObjectStoreAccountsApi:
    ...
    def api12_object_store_accounts_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api12_object_store_accounts_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/1.2/object-store-accounts', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
