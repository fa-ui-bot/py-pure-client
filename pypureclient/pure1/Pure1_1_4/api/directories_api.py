...
from pypureclient.pure1.Pure1_1_4.models.directory_get_response import DirectoryGetResponse
from typing import Optional
...
class DirectoriesApi:
    ...
    def api14_directories_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api14_directories_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
