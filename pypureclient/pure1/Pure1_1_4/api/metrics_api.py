...
from pypureclient.pure1.Pure1_1_4.models.metric_get_response import MetricGetResponse
from pypureclient.pure1.Pure1_1_4.models.metric_history_get_response import MetricHistoryGetResponse
from typing import Optional
...
class MetricsApi:
    ...
    def api14_metrics_get_with_http_info(
        self,
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api14_metrics_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def api14_metrics_history_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api14_metrics_history_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
