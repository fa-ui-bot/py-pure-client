...
from pypureclient.pure1.Pure1_1_4.models.network_interface_get_response import NetworkInterfaceGetResponse
from typing import Optional
...
class NetworkInterfacesApi:
    ...
    def api14_network_interfaces_get_with_http_info(
        self,
        ...
        **kwargs
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api14_network_interfaces_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/1.4/network-interfaces', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
